...
type: pilotage
matiere: pilotage
titre: Adaptations TSA — mode d'emploi des supports
resume: Les dix principes appliqués à tous les documents, ce qu'ils changent concrètement, et les réglages à ajuster au fil de l'année.
duree: Lecture 20 min
objectifs:
  - Comprendre pourquoi les documents sont construits ainsi
  - Savoir quoi ajuster quand quelque chose ne fonctionne pas
  - Disposer d'un protocole de séance stable et prévisible
---
...
4. Ce qui se règle au cas par cas
...
::: definition 8 — Redondance du sens
Chaque information portée par une couleur est **aussi** portée par un pictogramme **et**
par un mot. Un document imprimé en noir et blanc reste intégralement compréhensible.
**Effet attendu :** aucune information perdue, quel que soit le support.
:::
...
::: definition 10 — Exigence maintenue
Vocabulaire de 4ᵉ, attentes de 4ᵉ, contenus de 4ᵉ. Aucune formulation infantilisante.
Le ton est **calme, direct, factuel**, encourageant sans excès ni enthousiasme forcé.
**Effet attendu :** respect, et donc adhésion.
:::
...
2. **Réactivation** (5 min) — trois questions sur la séance précédente. Objectif : réussir, pas évaluer.
3. **Découverte** (20 min) — fiche de cours, blocs 1 à 4. Lecture à voix haute possible si elle aide.
4. **🔁 Pause** (5 min) — vraie pause, sans écran, sans question sur le cours.
5. **Découverte** (20 min) — fiche de cours, blocs suivants.
6. **Application** (15 min) — exercices de niveau *Application* uniquement, corrigé vérifié après chaque exercice.
7. **Clôture** (5 min) — un point sur la grille d'évaluation, et annonce de la séance suivante.
:::
...
Les changements d'activité sont le moment le plus coûteux. Trois réflexes :
...
|---|---|---|
| **Durée des blocs** | 15 / 20 / 25 min | Si décrochage systématique avant la fin, raccourcir avant de conclure quoi que ce soit |
| **Lecture** | Silencieuse / à voix haute / lue par l'adulte | Selon la fatigue du jour, pas selon la matière |
| **Écrit** | Manuscrit / clavier | Le clavier est un aménagement légitime, pas un contournement |
| **Corrigé** | Masqué / visible d'emblée | Visible d'emblée pendant la phase de découverte, masqué en entraînement |
| **Ordre des exercices** | Imposé / au choix | Laisser le choix du premier exercice réduit fortement le coût d'entrée |
| **Nombre d'exercices** | Tous / une sélection annoncée | Annoncer « 5 exercices » et s'y tenir vaut mieux que « on verra » |
:::
...
|---|---|---|
| Blocage à l'entrée, sans lire l'énoncé | Coût d'initiation, pas incompréhension | Lire l'énoncé à voix haute et faire ensemble la première ligne |
| Réponse juste mais incomplète | Consigne multiple « avalée » | Re-découper la consigne, ne pas compter l'erreur |
| Question répétée sur la même chose | Besoin de certitude, pas d'oubli | Répondre à l'identique, calmement, autant de fois que nécessaire |
| Irritation sur un détail de forme | Surcharge atteinte | Pause immédiate, reprise ensuite au même endroit |
| Performance excellente puis effondrement | Fatigue cognitive, pas démotivation | Raccourcir la séance suivante, pas la rendre plus facile |
...
: *(à compléter — les exemples de problèmes, de textes et de thèmes de rédaction s'appuieront dessus en priorité)*

**Durée d'attention observée avant pause**
: *(à compléter — remplace la valeur de 20 min utilisée par défaut)*

**Modalité de lecture la plus confortable**
: *(à compléter)*

**Format d'écrit le plus confortable**
: *(à compléter)*

**Sensibilités sensorielles à prendre en compte**
: *(à compléter — lumière, bruit, police, contraste, couleurs à éviter)*

**Aménagements officiels en place (PAP / PPS / PAI)**
: *(à compléter — notamment le tiers-temps et l'usage de l'ordinateur, qui doivent être appliqués dès les entraînements et pas seulement le jour du devoir)*
:::

::: retenir Ce qu'il faut retenir
- On adapte la **forme**, jamais le **fond**.
- La **prévisibilité** vaut plus que la variété : même structure, même ordre, toujours.
- Une consigne = **une action**, écrite littéralement.
- La **pause est prévue** dans le document : elle est légitime.
- Ce qui est **observé** prime sur ce qui est écrit ici : la section 6 est la plus importante du document.
:::
