...
,
  'anglais-lv1/L05': {
    ...
    items: [
      { type: 'qcm', question: 'Où se place l’adjectif en anglais ?', choix: ['avant le nom', 'après le nom', 'en fin de phrase', 'au choix'], reponse: 0, explication: 'a big house, et jamais a house big. L’adjectif anglais précède toujours le nom qu’il décrit, contrairement au français où il suit le plus souvent.' },
      { type: 'vraifaux', question: 'L’adjectif anglais prend un s au pluriel.', reponse: false, explication: 'Faux. two big houses, jamais two bigs houses. L’adjectif anglais est invariable : il ne s’accorde ni en genre ni en nombre. C’est une règle sans exception.' },
      { type: 'qcm', question: 'Lequel de ces adjectifs compte comme court ?', choix: ['happy', 'modern', 'famous', 'careful'], reponse: 0, explication: 'happy a deux syllabes mais finit par -y : il compte comme court et donne happier. modern, famous et careful ont deux syllabes sans -y, ils sont donc longs.' },
      { type: 'saisie', question: 'Donne le comparatif de « big ».', reponses: ['bigger', 'bigger than'], explication: 'big finit par une voyelle suivie d’une seule consonne : on double la consonne, d’où bigger. Compare avec fast, qui finit par deux consonnes et donne faster sans doublement.' },
      { type: 'qcm', question: 'Quelle phrase est correcte ?', choix: ['He is taller than me.', 'He is more taller than me.', 'He is more tall than me.', 'He is tallest than me.'], reponse: 0, explication: 'tall est court : il prend -er. Un adjectif prend -er OU more, jamais les deux. more taller est l’erreur la plus fréquente du chapitre.' },
      { type: 'qcm', question: 'Complète : This film is ……… than the book.', choix: ['more interesting', 'interestinger', 'more interestinger', 'the most interesting'], reponse: 0, explication: 'interesting a quatre syllabes : c’est un adjectif long, il prend more. La forme interestinger n’existe pas.' },
      { type: 'saisie', question: 'Complète : She is ……… tall ……… her brother. (égalité, les deux mots manquants sont identiques)', reponses: ['as', 'as as'], explication: 'as tall as : le comparatif d’égalité demande DEUX as. Un seul rend la phrase incompréhensible. À la forme niée : not as tall as.' },
      { type: 'vraifaux', question: 'Le superlatif s’emploie toujours avec « the ».', reponse: true, explication: 'Vrai. the tallest, the most expensive. Oublier the est le piège 3 de la fiche, et il coûte un point à chaque occurrence dans un devoir.' },
      { type: 'qcm', question: 'Quel est le superlatif de « good » ?', choix: ['the best', 'the goodest', 'the most good', 'the better'], reponse: 0, explication: 'good → better → the best. C’est un irrégulier : il ne suit aucune règle de longueur et change complètement de forme.' },
      { type: 'saisie', question: 'Quel est le superlatif de « bad » ? (deux mots)', reponses: ['the worst', 'worst'], explication: 'bad → worse → the worst. Avec good, c’est l’irrégulier qui revient le plus souvent : il faut le connaître par cœur.' },
      { type: 'qcm', question: 'Complète : He is the tallest boy ……… the class.', choix: ['in', 'of', 'from', 'at'], reponse: 0, explication: 'in devant un lieu ou un groupe de personnes : the tallest in the class. of devant une période ou une quantité : the best day of the year.' },
      { type: 'qcm', question: 'Quelle phrase est correcte ?', choix: ['She sings well.', 'She sings good.', 'She sings gooder.', 'She sings the good.'], reponse: 0, explication: 'sings est un verbe : il demande l’adverbe well, pas l’adjectif good. On dit a good singer mais she sings well. Les deux donnent better au comparatif.' },
      { type: 'vraifaux', question: 'On écrit : He is taller then me.', reponse: false, explication: 'Faux. than sert à comparer, then signifie « ensuite ». Les deux mots se prononcent presque pareil mais ne s’écrivent pas pareil : c’est le piège 5 de la fiche.' },
      { type: 'qcm', question: 'Comment dit-on « elle a de longs cheveux bruns » ?', choix: ['She has long dark hair.', 'She has dark long hair.', 'She has longs dark hairs.', 'She has hair long dark.'], reponse: 0, explication: 'La taille vient avant la couleur : long dark hair. Et hair est indénombrable en anglais : il ne prend jamais de s.' },
      { type: 'qcm', question: 'Complète : Brest is ……… big ……… Nantes. (Brest est plus petit)', choix: ['not as … as', 'as … as', 'more … than', 'the most … of'], reponse: 0, explication: 'not as big as exprime l’égalité niée : Brest n’est pas aussi grand que Nantes. L’anglais préfère cette tournure à less big, plus rare à l’oral.' },
      { type: 'saisie', question: 'Donne le comparatif de « happy ».', reponses: ['happier', 'happier than'], explication: 'happy finit par consonne + y : le y devient i avant -er, d’où happier. Même règle pour easy → easier et funny → funnier.' },
      { type: 'vraifaux', question: '« Brest is smaller than Paris » et « Paris is bigger than Brest » décrivent la même réalité.', reponse: true, explication: 'Vrai. Pour changer l’adjectif par son contraire, il faut inverser les deux éléments en même temps. Sans cette inversion, la phrase dit l’inverse de l’original.' },
      { type: 'qcm', question: 'Corrige : It is the most easiest exercise.', choix: ['It is the easiest exercise.', 'It is the most easy exercise.', 'It is more easiest exercise.', 'La phrase est correcte.'], reponse: 0, explication: 'Double superlatif : the most et -est ne se cumulent jamais. easy est court, donc the easiest suffit.' },
      { type: 'qcm', question: 'Pour décrire les yeux de quelqu’un, quel verbe emploie-t-on ?', choix: ['to have : she has green eyes', 'to be : she is green eyes', 'to make : she makes green eyes', 'to do : she does green eyes'], reponse: 0, explication: 'to have devant un nom : she has green eyes, she has long hair. to be devant un adjectif : she is tall, she is shy.' },
      { type: 'qcm', question: 'Quelle structure introduit un point commun entre deux éléments ?', choix: ['Both … are as … as', 'More … than', 'The most … of', 'Less … than'], reponse: 0, explication: 'Both introduit ce que les deux éléments partagent, et as … as mesure l’égalité. Un bon paragraphe de comparaison commence par un point commun avant de donner les différences.' }
    ]
  }
,
  'espagnol-lv2/L04': {
    ...
    items: [
      { type: 'saisie', question: 'Comment dit-on « la mairie » en espagnol ?', reponses: ['el ayuntamiento', 'ayuntamiento'], explication: 'el ayuntamiento désigne la mairie comme bâtiment et comme institution. Le mot vient de ayuntar, réunir : c’est le lieu où le conseil se réunit.' },
      { type: 'qcm', question: 'Que signifie « la librería » ?', choix: ['la librairie', 'la bibliothèque', 'la liberté', 'le libraire'], reponse: 0, explication: 'C’est un faux ami : la librería vend des livres, la biblioteca les prête. Pour emprunter un livre, on va a la biblioteca.' },
      { type: 'qcm', question: 'Complète : Voy ……… pie.', choix: ['a', 'en', 'de', 'por'], reponse: 0, explication: 'Tous les moyens de transport prennent en : en autobús, en metro, en bici. Seule la marche prend a : a pie. C’est la seule exception.' },
      { type: 'saisie', question: 'Que donne la contraction de « a » + « el » ?', reponses: ['al'], explication: 'a + el = al : Voy al parque. De même de + el = del : al lado del museo. La contraction est obligatoire et ne concerne que l’article masculin singulier el.' },
      { type: 'vraifaux', question: 'On écrit : La farmacia está al lado de el banco.', reponse: false, explication: 'Faux. de + el se contracte obligatoirement en del : al lado del banco. En revanche, on dit bien al lado de la plaza, car la contraction ne concerne que el.' },
      { type: 'qcm', question: 'Quel est l’impératif affirmatif de « girar » au tutoiement ?', choix: ['gira', 'gire', 'giras', 'girar'], reponse: 0, explication: 'On prend la 3e personne du singulier du présent : él gira, donc ¡Gira ! La forme gire est celle du vouvoiement.' },
      { type: 'qcm', question: 'Quel est l’impératif affirmatif de « comer » au vouvoiement ?', choix: ['coma', 'come', 'comes', 'comed'], reponse: 0, explication: 'C’est un échange de voyelles : les verbes en -ar prennent -e (hable, gire), ceux en -er et -ir prennent -a (coma, suba).' },
      { type: 'saisie', question: 'Comment dit-on « ne tourne pas » au tutoiement ? (deux mots)', reponses: ['no gires'], explication: 'Le négatif ne se calque JAMAIS sur l’affirmatif : on part de la forme usted, gire, et on ajoute un s. no gira est faux, c’est le piège principal du chapitre.' },
      { type: 'vraifaux', question: 'L’impératif négatif au tutoiement se forme en ajoutant « no » devant la forme affirmative.', reponse: false, explication: 'Faux. Il se forme sur la forme de vouvoiement, plus un s : gire → no gires, coma → no comas, vaya → no vayas. C’est la difficulté principale du chapitre.' },
      { type: 'qcm', question: 'Quel est l’impératif de « hacer » au tutoiement ?', choix: ['haz', 'hace', 'haga', 'haces'], reponse: 0, explication: 'hacer est irrégulier : haz au tutoiement, haga au vouvoiement. Les huit irréguliers ont tous une forme très courte au tutoiement.' },
      { type: 'saisie', question: 'Quel est l’impératif de « salir » au tutoiement ? (un mot)', reponses: ['sal'], explication: 'salir donne sal, et non sale, qui est la 3e personne du présent. Au vouvoiement : salga, bâti sur salgo, la 1re personne du présent.' },
      { type: 'qcm', question: 'Quel est l’impératif de « ir » au vouvoiement ?', choix: ['vaya', 've', 'va', 'irá'], reponse: 0, explication: 'ir donne ve au tutoiement et vaya au vouvoiement. Attention : ve est aussi l’impératif de ver, voir. Le contexte tranche.' },
      { type: 'qcm', question: 'Comment dit-on « continue tout droit » au tutoiement ?', choix: ['sigue todo recto', 'siga todo recto', 'seguir todo recto', 'sigues todo recto'], reponse: 0, explication: 'seguir change de voyelle : él sigue, donc sigue au tutoiement et siga au vouvoiement. seguir todo recto serait un infinitif, pas une consigne.' },
      { type: 'qcm', question: 'Quelle phrase est correcte pour chercher une pharmacie, n’importe laquelle ?', choix: ['¿Dónde hay una farmacia ?', '¿Dónde está una farmacia ?', '¿Dónde hay la farmacia ?', '¿Dónde es una farmacia ?'], reponse: 0, explication: 'hay s’emploie avec un article indéfini, pour n’importe quel exemplaire. está s’emploie avec un article défini, pour un lieu précis que je cherche.' },
      { type: 'saisie', question: 'Comment dit-on « en face de » ? (deux mots)', reponses: ['enfrente de', 'frente a'], explication: 'enfrente de la plaza, enfrente del museo. Comme toutes les prépositions en de, elle se contracte devant el.' },
      { type: 'vraifaux', question: '« Girar a la derecha » est une consigne correcte.', reponse: false, explication: 'Faux. C’est un infinitif, pas un impératif. La consigne se dit Gira a la derecha au tutoiement, Gire a la derecha au vouvoiement.' },
      { type: 'qcm', question: 'Comment dit-on « le feu tricolore » ?', choix: ['el semáforo', 'el fuego', 'la luz', 'el cruce'], reponse: 0, explication: 'el semáforo. Attention à l’accent sur le a. el cruce est le carrefour, la esquina le coin de rue.' },
      { type: 'qcm', question: 'Quelle est la différence entre « está » et « esta » ?', choix: ['está est le verbe, esta signifie « cette »', 'aucune, c’est la même chose', 'está est un nom, esta un verbe', 'está est au pluriel'], reponse: 0, explication: 'L’accent change le mot : está est la 3e personne de estar, esta est un déterminant démonstratif. Oublier l’accent change le sens de la phrase.' },
      { type: 'saisie', question: 'Comment dit-on « traverse la place » au tutoiement ? (trois mots)', reponses: ['cruza la plaza'], explication: 'cruzar donne cruza au tutoiement, cruce au vouvoiement, et no cruces au négatif tutoyé. Le z devient c devant e, par règle d’orthographe.' },
      { type: 'qcm', question: 'Quel mot enchaîne deux étapes d’un itinéraire ?', choix: ['luego', 'porque', 'pero', 'aunque'], reponse: 0, explication: 'luego ou después signifient « ensuite ». Avec primero, hasta et al final, ce sont les mots qui transforment une liste de lieux en un vrai parcours.' }
    ]
  }
,
  'espagnol-lv2/L05': {
    ...
    items: [
      { type: 'qcm', question: 'Comment se construit le pretérito perfecto ?', choix: ['haber au présent + participe passé', 'tener au présent + participe passé', 'ser au présent + participe passé', 'estar au présent + gérondif'], reponse: 0, explication: 'haber est l’auxiliaire unique de ce temps, pour tous les verbes, y compris ceux qui prennent « être » en français : han salido, jamais son salidos.' },
      { type: 'saisie', question: 'Conjugue haber à la première personne du pluriel (nosotros).', reponses: ['hemos'], explication: 'he, has, ha, hemos, habéis, han. Le h ne se prononce jamais en espagnol, mais il s’écrit toujours, et habéis porte un accent sur le e.' },
      { type: 'qcm', question: 'Quelle est la terminaison du participe des verbes en -ar ?', choix: ['-ado', '-ido', '-to', '-cho'], reponse: 0, explication: 'hablar → hablado. Les verbes en -er et -ir prennent -ido : comer → comido, vivir → vivido. Il n’existe pas d’autre cas régulier.' },
      { type: 'saisie', question: 'Quel est le participe passé de « hacer » ?', reponses: ['hecho'], explication: 'hacer → hecho, pas hacido. Six des huit irréguliers finissent par -to, deux par -cho : aucun ne finit par -ado ni -ido, ce qui permet de repérer une erreur d’un coup d’œil.' },
      { type: 'saisie', question: 'Quel est le participe passé de « ver » ?', reponses: ['visto'], explication: 'ver → visto. Les huit irréguliers du programme : hecho, dicho, visto, escrito, vuelto, puesto, abierto, roto.' },
      { type: 'vraifaux', question: 'Le participe s’accorde avec le sujet après haber.', reponse: false, explication: 'Faux. Ellas han comido, jamais comidas. Le participe est invariable après haber : c’est plus simple qu’en français, où l’accord dépend du complément.' },
      { type: 'qcm', question: 'Lequel de ces marqueurs appelle le pretérito perfecto ?', choix: ['este año', 'ayer', 'en 2019', 'hace dos años'], reponse: 0, explication: 'este año désigne une période encore en cours. ayer, en 2019 et hace dos años désignent des périodes closes, qui appellent un autre temps.' },
      { type: 'qcm', question: 'Quelle question permet de savoir s’il faut employer ce temps ?', choix: ['la période dont je parle est-elle finie ?', 'le verbe est-il irrégulier ?', 'le sujet est-il au pluriel ?', 'la phrase est-elle longue ?'], reponse: 0, explication: 'Si la période est encore en cours, hoy, esta semana, este año, c’est le pretérito perfecto. Si elle est close et datée, l’espagnol emploie un autre temps.' },
      { type: 'qcm', question: 'Où se place « no » dans une phrase négative ?', choix: ['devant haber', 'entre haber et le participe', 'après le participe', 'en fin de phrase'], reponse: 0, explication: 'No he comido. Tout se place avant l’auxiliaire : d’abord no, puis les pronoms, puis haber, puis le participe.' },
      { type: 'qcm', question: 'Comment dit-on « je l’ai vu » (masculin) ?', choix: ['Lo he visto.', 'He lo visto.', 'He visto lo.', 'Lo visto he.'], reponse: 0, explication: 'Le pronom se place devant haber, jamais entre l’auxiliaire et le participe. Avec une négation : No lo he visto.' },
      { type: 'vraifaux', question: 'On peut écrire : He siempre pensado eso.', reponse: false, explication: 'Faux. haber et le participe forment un bloc que rien ne coupe. On dit Siempre he pensado eso, ou He pensado siempre en eso, mais jamais au milieu.' },
      { type: 'qcm', question: 'Quel est le participe de « volver » ?', choix: ['vuelto', 'volvido', 'volvado', 'vuelvido'], reponse: 0, explication: 'volver → vuelto. Et son composé devolver, rendre, donne devuelto : un verbe composé garde toujours l’irrégularité du verbe simple qu’il contient.' },
      { type: 'saisie', question: 'Quel est le participe passé de « escribir » ?', reponses: ['escrito'], explication: 'escribir → escrito. Son composé describir donne descrito. Savoir reconnaître le verbe simple évite d’apprendre une seconde liste.' },
      { type: 'qcm', question: 'Quelle phrase est correcte ?', choix: ['Tengo un libro nuevo.', 'He un libro nuevo.', 'Ha un libro nuevo.', 'Hemos un libro nuevo.'], reponse: 0, explication: 'haber est un auxiliaire : il ne s’emploie jamais seul pour dire « avoir » au sens de posséder. La possession se dit avec tener.' },
      { type: 'qcm', question: 'Comment dit-on « je n’ai pas encore fini » ?', choix: ['Todavía no he terminado.', 'No todavía he terminado.', 'He todavía no terminado.', 'No he terminado todavía no.'], reponse: 0, explication: 'todavía no se place en tête, devant l’auxiliaire. On peut aussi dire No he terminado todavía, avec todavía rejeté en fin de phrase.' },
      { type: 'vraifaux', question: 'On écrit : Nunca no he estado allí.', reponse: false, explication: 'Faux. Une seule négation : Nunca he estado allí, ou No he estado nunca allí. Les deux tournures existent, mais elles ne se mélangent pas.' },
      { type: 'saisie', question: 'Quel est le participe passé de « abrir » ?', reponses: ['abierto'], explication: 'abrir → abierto, avec la diphtongue ie. Attention à ne pas écrire abrido : aucun irrégulier ne finit en -ido.' },
      { type: 'qcm', question: 'Corrige : Ayer he ido al cine.', choix: ['Ayer fui al cine.', 'Ayer he ir al cine.', 'Ayer había ido al cine.', 'La phrase est correcte.'], reponse: 0, explication: 'ayer désigne une période close : le pretérito perfecto ne convient pas. On emploie l’indefinido, étudié au chapitre suivant.' },
      { type: 'qcm', question: 'Comment dit-on « as-tu déjà fini ? »', choix: ['¿Has terminado ya ?', '¿Ya has terminar ?', '¿Tienes terminado ya ?', '¿Has ya terminado ?'], reponse: 0, explication: 'ya se place après le participe ou en tête de phrase, jamais entre haber et le participe. L’ordre est : mot interrogatif, haber, participe, reste.' },
      { type: 'qcm', question: 'Dans « Nunca la he visto », que remplace « la » ?', choix: ['un nom féminin singulier déjà mentionné', 'le sujet de la phrase', 'un lieu', 'rien, c’est un article'], reponse: 0, explication: 'la est un pronom complément d’objet direct féminin singulier, par exemple la película. Il se glisse entre nunca et he, toujours devant l’auxiliaire.' }
    ]
  }
,
  'maths/L06': {
    ...
    items: [
      { type: 'qcm', question: 'Comment calcule-t-on la fréquence d’une valeur ?', choix: ['effectif ÷ effectif total', 'effectif total ÷ effectif', 'effectif × effectif total', 'effectif − effectif total'], reponse: 0, explication: 'La fréquence est la part que représente une valeur dans l’ensemble. En pourcentage : (effectif ÷ effectif total) × 100.' },
      { type: 'saisie', question: 'Que vaut toujours la somme des fréquences d’une série ? (un chiffre)', reponses: ['1', 'un'], explication: 'La somme des fréquences vaut 1, soit 100 %. Si tu trouves 0,98 ou 1,04, c’est qu’une fréquence est fausse : recalcule-les une par une.' },
      { type: 'qcm', question: 'Peut-on calculer la moyenne de la couleur des yeux d’une classe ?', choix: ['non, le caractère est qualitatif', 'oui, en numérotant les couleurs', 'oui, si l’effectif est grand', 'oui, avec la médiane'], reponse: 0, explication: 'Les trois indicateurs ne s’appliquent qu’aux caractères quantitatifs. Le test : additionner deux valeurs a-t-il un sens ? bleu + vert n’en a aucun.' },
      { type: 'qcm', question: 'Pour une série donnée en tableau, par quoi divise-t-on pour obtenir la moyenne ?', choix: ['par l’effectif total', 'par le nombre de valeurs différentes', 'par la plus grande valeur', 'par le nombre de colonnes'], reponse: 0, explication: 'C’est l’erreur la plus fréquente du chapitre. Pour 25 élèves répartis sur 5 notes, on divise par 25, pas par 5.' },
      { type: 'saisie', question: 'Notes 8, 10, 12 avec effectifs 2, 3, 5. Quelle est la moyenne ?', reponses: ['10,6', '10.6'], explication: '8×2 + 10×3 + 12×5 = 16 + 30 + 60 = 106. Effectif total : 2 + 3 + 5 = 10. Moyenne : 106 ÷ 10 = 10,6.' },
      { type: 'vraifaux', question: 'On peut chercher la médiane sans ranger la série.', reponse: false, explication: 'Faux. Il faut TOUJOURS ranger dans l’ordre croissant d’abord. Sur 7, 3, 9, 1, 5, lire la 3e valeur donnerait 9 ; après rangement, la médiane vaut 5.' },
      { type: 'qcm', question: 'La série a 5 valeurs. Quel est le rang de la médiane ?', choix: ['le 3e', 'le 2e', 'le 4e', 'la moyenne des 2e et 4e'], reponse: 0, explication: 'n est impair : rang = (n + 1) ÷ 2 = (5 + 1) ÷ 2 = 3. La médiane est la 3e valeur de la série rangée.' },
      { type: 'saisie', question: 'Quelle est la médiane de la série 4, 7, 9, 11 ?', reponses: ['8'], explication: 'n = 4, pair : la médiane est la moyenne des valeurs de rang 2 et 3, soit (7 + 9) ÷ 2 = 8. Elle ne fait donc pas partie de la série, et c’est normal.' },
      { type: 'vraifaux', question: 'En effectif pair, la médiane est l’une des deux valeurs centrales.', reponse: false, explication: 'Faux. C’est leur MOYENNE. Sur 8, 10, 12, 14, 15, 18, les valeurs centrales sont 12 et 14, et la médiane vaut 13.' },
      { type: 'qcm', question: 'Sur la série 0, 1, 2, 3, 100, combien vaut la médiane ?', choix: ['2', '50', '21,2', '100'], reponse: 0, explication: 'La médiane est au milieu des INDIVIDUS, pas au milieu de l’échelle. La 3e des cinq valeurs est 2. La moyenne, elle, vaut 21,2 : l’écart entre les deux signale une valeur aberrante.' },
      { type: 'saisie', question: 'Quelle est l’étendue de la série 12, 15, 9, 14, 10 ?', reponses: ['6'], explication: 'Étendue = plus grande valeur − plus petite = 15 − 9 = 6. C’est une différence, un seul nombre, et non un intervalle : on n’écrit pas « de 9 à 15 ».' },
      { type: 'vraifaux', question: 'Deux séries de même étendue ont forcément la même moyenne.', reponse: false, explication: 'Faux. 0, 0, 20 et 0, 10, 20 ont toutes deux une étendue de 20, mais leurs moyennes valent environ 6,7 et 10. L’étendue ne regarde que les deux extrêmes.' },
      { type: 'qcm', question: 'Salaires : 1500, 1600, 1600, 1700, 1800, 12000. Quel indicateur décrit le mieux la situation ?', choix: ['la médiane, 1650 €', 'la moyenne, environ 3367 €', 'l’étendue, 10500 €', 'aucun des trois'], reponse: 0, explication: 'Un seul salaire très élevé tire la moyenne vers le haut : cinq employés sur six gagnent moins qu’elle. La médiane, qui ne regarde que le rang, reste à 1650 €.' },
      { type: 'qcm', question: 'Quand la moyenne dépasse nettement la médiane, cela signale :', choix: ['une ou plusieurs valeurs bien plus grandes que les autres', 'une erreur de calcul', 'une série de petite taille', 'un caractère qualitatif'], reponse: 0, explication: 'La série est étirée vers le haut. L’écart entre les deux indicateurs est en lui-même une information sur la forme de la série : il ne faut jamais négliger de les comparer.' },
      { type: 'qcm', question: 'Deux classes ont la même moyenne de 12, mais des étendues de 8 et 17. Que peut-on dire ?', choix: ['les résultats sont bien plus dispersés dans la seconde', 'les deux classes sont identiques', 'la seconde classe est meilleure', 'on ne peut rien dire'], reponse: 0, explication: 'La moyenne seule ne décrit pas une série. Il faut lui adjoindre au moins un indicateur de dispersion, ici l’étendue, qui révèle deux situations très différentes.' },
      { type: 'saisie', question: 'Sur 25 élèves, 10 font du football. Quel est l’angle du secteur dans un diagramme circulaire ? (en degrés, chiffre seul)', reponses: ['144', '144°'], explication: 'angle = (effectif ÷ effectif total) × 360 = (10 ÷ 25) × 360 = 0,4 × 360 = 144°. La somme de tous les angles doit faire 360°.' },
      { type: 'qcm', question: 'Quel est le premier réflexe devant un graphique ?', choix: ['regarder où commence l’axe vertical', 'regarder les couleurs', 'lire la valeur la plus haute', 'compter les barres'], reponse: 0, explication: 'Un axe qui ne part pas de zéro exagère les écarts. Les deux autres contrôles : les graduations sont-elles régulières, et le dessin montre-t-il des nombres ou des surfaces ?' },
      { type: 'vraifaux', question: 'Un club passe de 95 à 100 adhérents : c’est une hausse de plus de 5 %.', reponse: false, explication: 'Faux. (100 − 95) ÷ 95 × 100 ≈ 5,3 %, donc à peine plus de 5 %. Avec un axe partant de 94, la barre paraît pourtant doubler : c’est le procédé le plus courant pour exagérer une variation.' },
      { type: 'qcm', question: 'La moyenne de 20 élèves est 11. Quelle est la somme de leurs notes ?', choix: ['220', '31', '11', '200'], reponse: 0, explication: 'On emploie la formule à l’envers : somme = moyenne × effectif = 11 × 20 = 220. Cette étape est indispensable dès qu’on ajoute ou retire un individu.' },
      { type: 'qcm', question: 'Un tableau donne les notes d’un seul contrôle. L’affirmation « la classe a progressé » est :', choix: ['impossible à vérifier', 'exacte', 'inexacte', 'vérifiable par la médiane'], reponse: 0, explication: 'Une progression demande DEUX séries, pas une. Distinguer ce qui est faux de ce qui est simplement invérifiable est un réflexe aussi important que le calcul lui-même.' }
    ]
  }
,
  'maths/L07': {
    titre: 'Probabilités',
    items: [
      { type: 'qcm', question: 'Qu’est-ce qu’une expérience aléatoire ?', choix: ['on connaît les résultats possibles, pas celui qui sortira', 'on ne connaît aucun résultat possible', 'le résultat est toujours le même', 'il n’y a qu’un seul résultat possible'], reponse: 0, explication: '« Aléatoire » ne veut pas dire « inconnu » : on connaît parfaitement la liste des issues. Ce qu’on ignore, c’est laquelle se produira.' },
      { type: 'qcm', question: 'Quelle est la formule de la probabilité en situation d’équiprobabilité ?', choix: ['issues favorables ÷ issues possibles', 'issues possibles ÷ issues favorables', 'issues favorables × issues possibles', 'issues possibles − issues favorables'], reponse: 0, explication: 'Attention à la condition : la formule n’est valable que si TOUTES les issues ont la même chance. Sur une roue à secteurs inégaux, il faut raisonner sur les surfaces.' },
      { type: 'saisie', question: 'Quelle est la probabilité d’obtenir un nombre pair avec un dé à six faces ? (en décimal)', reponses: ['0,5', '0.5', '1/2', '3/6'], explication: 'Trois issues favorables, 2, 4 et 6, sur six possibles : 3 ÷ 6 = 0,5. Vérifie toujours que ton résultat est bien compris entre 0 et 1.' },
      { type: 'qcm', question: 'Entre quelles valeurs une probabilité est-elle toujours comprise ?', choix: ['entre 0 et 1', 'entre 0 et 100', 'entre −1 et 1', 'il n’y a pas de limite'], reponse: 0, explication: '0 pour un événement impossible, 1 pour un événement certain. Un résultat négatif ou supérieur à 1 signale forcément une erreur de calcul.' },
      { type: 'vraifaux', question: 'La somme des probabilités de toutes les issues vaut 1.', reponse: true, explication: 'Vrai, et c’est le contrôle le plus rapide. Sur un dé : 1/6 répété six fois donne 6/6 = 1. Si ta somme ne fait pas 1, une probabilité est fausse.' },
      { type: 'qcm', question: 'Une roue a un secteur rouge occupant la moitié du disque et trois autres secteurs d’un sixième chacun. Quelle est la probabilité du rouge ?', choix: ['0,5', '0,25', '1/6', '1/3'], reponse: 0, explication: 'Il y a bien quatre secteurs, mais ils ne sont PAS équiprobables. On raisonne sur les surfaces : le rouge occupe la moitié, donc 0,5. Diviser par 4 serait le piège numéro un du chapitre.' },
      { type: 'qcm', question: 'Quelle est la formule de l’événement contraire ?', choix: ['P(non A) = 1 − P(A)', 'P(non A) = −P(A)', 'P(non A) = 1 ÷ P(A)', 'P(non A) = P(A)'], reponse: 0, explication: 'La somme d’un événement et de son contraire vaut toujours 1. On y pense dès qu’un énoncé contient « au moins » : compter l’inverse est alors bien plus rapide.' },
      { type: 'qcm', question: 'Quel est le contraire de « obtenir un nombre supérieur à 2 » ?', choix: ['obtenir un nombre inférieur ou égal à 2', 'obtenir un nombre inférieur à 2', 'obtenir un nombre supérieur ou égal à 2', 'obtenir 2'], reponse: 0, explication: 'Sans « ou égal », on perdrait l’issue 2. Le contraire de « strictement supérieur à » est toujours « inférieur OU ÉGAL à ».' },
      { type: 'saisie', question: 'Combien y a-t-il d’issues quand on lance deux dés à six faces ? (chiffre seul)', reponses: ['36'], explication: '6 × 6 = 36. Le nombre d’issues d’une expérience à deux épreuves est le PRODUIT des issues de chaque épreuve, jamais leur somme.' },
      { type: 'qcm', question: 'Un sac contient 5 boules. On en tire 2 SANS remise. Combien d’issues ?', choix: ['20', '25', '10', '5'], reponse: 0, explication: '5 × 4 = 20. Sans remise, la seconde épreuve a une issue de moins, car une boule a quitté le sac. Avec remise, ce serait 5 × 5 = 25.' },
      { type: 'vraifaux', question: 'Avec deux pièces, (P ; F) et (F ; P) sont la même issue.', reponse: false, explication: 'Faux. L’ordre compte : ce sont DEUX issues distinctes. Les confondre donne 3 issues au lieu de 4, et toutes les probabilités deviennent fausses.' },
      { type: 'saisie', question: 'On lance deux pièces. Quelle est la probabilité d’obtenir exactement un pile ? (en décimal)', reponses: ['0,5', '0.5', '1/2', '2/4'], explication: 'Deux issues favorables, (P ; F) et (F ; P), sur quatre possibles : 2 ÷ 4 = 0,5. Obtenir deux piles n’a, lui, qu’une chance sur quatre.' },
      { type: 'qcm', question: 'Quelle somme est la plus probable avec deux dés ?', choix: ['7', '2', '12', 'toutes les sommes ont la même probabilité'], reponse: 0, explication: '7 s’obtient de six façons différentes, alors que 2 et 12 ne s’obtiennent chacun que d’une seule. Les 36 couples sont équiprobables ; les sommes, non.' },
      { type: 'saisie', question: 'Quelle est la probabilité d’obtenir une somme de 12 avec deux dés ? (sous la forme a/b)', reponses: ['1/36'], explication: 'Un seul couple donne 12 : (6 ; 6). Une case sur 36. C’est pourquoi on compte toujours les issues, jamais les résultats.' },
      { type: 'qcm', question: 'Quelle est la différence entre fréquence et probabilité ?', choix: ['la fréquence est observée et varie, la probabilité est théorique et fixe', 'ce sont deux mots pour la même chose', 'la fréquence est théorique et la probabilité observée', 'la fréquence dépasse toujours la probabilité'], reponse: 0, explication: 'La probabilité se calcule avant l’expérience et ne change pas. La fréquence se mesure après et varie d’une série à l’autre, d’autant plus que les essais sont peu nombreux.' },
      { type: 'vraifaux', question: 'On lance 20 fois une pièce et on obtient 13 piles : la pièce est truquée.', reponse: false, explication: 'Faux, on ne peut rien conclure. Sur 20 lancers seulement, un tel écart est banal. Il faudrait un très grand nombre de lancers et un écart qui persiste pour soupçonner un truquage.' },
      { type: 'qcm', question: 'Que dit la loi des grands nombres ?', choix: ['sur un très grand nombre d’essais, la fréquence se rapproche de la probabilité', 'les écarts finissent par se compenser exactement', 'après cinq faces, pile devient plus probable', 'l’écart en nombre de succès diminue'], reponse: 0, explication: 'C’est la PROPORTION qui se stabilise, pas l’écart absolu : celui-ci augmente au contraire quand les essais se multiplient. La loi ne dit rien sur le prochain lancer.' },
      { type: 'vraifaux', question: '« Ça fait cinq fois face, pile va sortir » est un raisonnement correct.', reponse: false, explication: 'Faux. La pièce n’a aucune mémoire : la probabilité reste 0,5 à chaque lancer, quels que soient les résultats précédents. Ce raisonnement porte un nom : l’erreur du joueur.' },
      { type: 'qcm', question: '« Il y a deux issues au loto, gagner ou perdre, donc une chance sur deux. » Ce raisonnement est :', choix: ['faux, les deux issues ne sont pas équiprobables', 'juste', 'faux, il y a trois issues', 'juste si on joue souvent'], reponse: 0, explication: 'La formule ne vaut que pour des issues équiprobables. Gagner correspond à une seule combinaison parmi des millions : les deux issues n’ont évidemment pas la même chance.' },
      { type: 'qcm', question: 'Dans un jeu de 32 cartes, combien de cartes sont « un roi OU un cœur » ?', choix: ['11', '12', '8', '4'], reponse: 0, explication: '4 rois + 8 cœurs = 12, mais le roi de cœur serait compté deux fois. On le retire une fois : 4 + 8 − 1 = 11. Quand deux catégories se recoupent, on additionne puis on retire l’intersection.' }
    ]
  }
,
  'maths/L09': {
    ...
    items: [
      { type: 'qcm', question: 'Par quoi une translation est-elle définie ?', choix: ['un vecteur', 'une droite', 'un point', 'un angle'], reponse: 0, explication: 'Le vecteur donne à la fois une direction, un sens et une longueur. Tous les points de la figure subissent exactement le même déplacement.' },
      { type: 'qcm', question: 'Combien d’éléments faut-il pour définir une rotation ?', choix: ['trois : centre, angle et sens', 'deux : centre et angle', 'un : le centre', 'deux : angle et sens'], reponse: 0, explication: 'Sans le sens, il existe DEUX rotations de même centre et même angle, et elles donnent des images différentes. Un énoncé complet précise toujours le sens.' },
      { type: 'qcm', question: 'Quelle transformation retourne la figure ?', choix: ['la symétrie axiale', 'la symétrie centrale', 'la translation', 'la rotation'], reponse: 0, explication: 'C’est la seule qui inverse le sens de parcours : si on parcourt ABC dans le sens des aiguilles d’une montre, on parcourt son image dans le sens inverse. La figure apparaît en miroir.' },
      { type: 'qcm', question: 'À quelle transformation la rotation de 180° est-elle égale ?', choix: ['la symétrie centrale de même centre', 'la symétrie axiale', 'une translation', 'l’identité'], reponse: 0, explication: 'C’est le seul angle pour lequel le sens n’a plus d’importance : un demi-tour à droite ou à gauche conduit au même point diamétralement opposé.' },
      { type: 'vraifaux', question: 'Une rotation conserve les longueurs.', reponse: true, explication: 'Vrai, comme les trois autres transformations du chapitre. Elles conservent tout ce qui se mesure : longueurs, angles, aires. Une image plus grande signale une erreur de construction.' },
      { type: 'qcm', question: 'Quelle propriété n’est PAS conservée par la symétrie axiale ?', choix: ['le sens de parcours', 'les longueurs', 'les angles', 'le parallélisme'], reponse: 0, explication: 'C’est la seule ligne du tableau qui distingue les quatre transformations. Tout le reste est conservé par les quatre.' },
      { type: 'qcm', question: 'Quel est le seul point invariant d’une rotation ?', choix: ['son centre', 'aucun', 'tous les points de l’axe', 'le point le plus proche'], reponse: 0, explication: 'Le centre ne bouge pas, puisque sa distance à lui-même vaut 0. Tous les autres points décrivent un arc de cercle centré en lui.' },
      { type: 'vraifaux', question: 'Une translation de vecteur non nul a un point invariant.', reponse: false, explication: 'Faux. Tous les points se déplacent, sans exception. C’est ce qui distingue la translation de la rotation et des symétries, qui ont toutes au moins un point fixe.' },
      { type: 'qcm', question: 'Sur quadrillage, A a pour déplacement « 3 à droite, 2 en haut » depuis O. Quel est son déplacement après une rotation de 90° antihoraire ?', choix: ['2 à gauche, 3 en haut', '2 à droite, 3 en bas', '3 à gauche, 2 en bas', '3 à droite, 2 en bas'], reponse: 0, explication: 'On échange les deux nombres et on change le signe du premier. Dans le sens horaire, ce serait « 2 à droite, 3 en bas » ; à 180°, on change simplement les deux signes.' },
      { type: 'qcm', question: 'Comment trouve-t-on le centre d’une symétrie centrale ?', choix: ['c’est le milieu de [AA’]', 'c’est l’intersection des médiatrices', 'c’est le milieu de [AB]', 'il n’y en a pas'], reponse: 0, explication: 'Par définition, le centre est le milieu de chaque segment reliant un point à son image. C’est aussi le point où tous ces segments se coupent.' },
      { type: 'qcm', question: 'Comment trouve-t-on le centre d’une rotation ?', choix: ['à l’intersection des médiatrices de [AA’] et [BB’]', 'au milieu de [AA’]', 'au milieu de [AB]', 'au centre de la figure'], reponse: 0, explication: 'Le centre est à égale distance de A et A’, donc sur la médiatrice de [AA’] ; et à égale distance de B et B’, donc sur celle de [BB’]. Une seule médiatrice ne suffit pas.' },
      { type: 'qcm', question: 'Que donne l’enchaînement de deux symétries axiales d’axes parallèles ?', choix: ['une translation', 'une rotation', 'une symétrie axiale', 'une symétrie centrale'], reponse: 0, explication: 'Chaque symétrie retourne la figure ; deux la retournent donc deux fois, ce qui la remet à l’endroit. La longueur de la translation vaut le DOUBLE de la distance entre les axes.' },
      { type: 'qcm', question: 'Que donne l’enchaînement de deux symétries axiales d’axes sécants ?', choix: ['une rotation de centre leur intersection', 'une translation', 'une symétrie axiale', 'rien de particulier'], reponse: 0, explication: 'Le point d’intersection appartient aux deux axes : il est donc invariant par les deux symétries, et c’est le centre de la rotation obtenue.' },
      { type: 'saisie', question: 'Combien de polygones réguliers pavent le plan à eux seuls ? (chiffre)', reponses: ['3', 'trois'], explication: 'Trois : le triangle équilatéral, le carré et l’hexagone régulier. Leurs angles, 60°, 90° et 120°, divisent exactement 360°.' },
      { type: 'qcm', question: 'Pourquoi le pentagone régulier ne pave-t-il pas le plan ?', choix: ['son angle de 108° ne divise pas 360°', 'il a trop de côtés', 'ses côtés sont inégaux', 'il n’est pas convexe'], reponse: 0, explication: '360 ÷ 108 ≈ 3,33, ce n’est pas un entier. Trois pentagones laissent un trou de 36°, quatre se chevauchent de 72°. La condition est purement arithmétique.' },
      { type: 'qcm', question: 'Quelle est la différence entre direction et sens ?', choix: ['la direction est celle de la droite, le sens précise lequel des deux parcours', 'ce sont deux mots pour la même chose', 'la direction est un angle, le sens une longueur', 'le sens est celui de la lecture'], reponse: 0, explication: 'Deux translations opposées ont la MÊME direction, horizontale par exemple, mais des sens contraires. Confondre les deux mots rend impossible la description d’une translation.' },
      { type: 'vraifaux', question: 'Pour construire l’image d’une figure, on peut relier les images dans n’importe quel ordre.', reponse: false, explication: 'Faux. On relie les images dans le MÊME ordre que la figure de départ. Un ordre différent produit une figure différente, même si les sommets sont correctement placés.' },
      { type: 'qcm', question: 'M’ est l’image de M par la translation qui envoie A sur B lorsque :', choix: ['ABM’M est un parallélogramme', 'ABMM’ est un carré', 'A est le milieu de [MM’]', 'les droites (AB) et (MM’) sont perpendiculaires'], reponse: 0, explication: 'C’est la caractérisation de la translation. Autrement dit, [AM’] et [BM] ont le même milieu, et AB = MM’ avec (AB) parallèle à (MM’).' },
      { type: 'qcm', question: 'Pour quels angles une rotation de centre O laisse-t-elle un carré de centre O globalement inchangé ?', choix: ['les multiples de 90°', 'les multiples de 45°', 'les multiples de 120°', '180° seulement'], reponse: 0, explication: 'Les quatre sommets sont régulièrement espacés de 360 ÷ 4 = 90°. Règle générale : un polygone régulier à n côtés est inchangé par les rotations d’angle multiple de 360 ÷ n.' },
      { type: 'vraifaux', question: 'Une figure et son image par une translation sont superposables.', reponse: true, explication: 'Vrai, et c’est vrai des quatre transformations du chapitre. Elles conservent toutes les mesures : on peut décalquer la figure de départ et la poser exactement sur son image.' }
    ]
  }
,
  'francais/L09': {
    ...
    items: [
      { type: 'qcm', question: 'À la voix passive, que fait le sujet ?', choix: ['il subit l’action', 'il fait l’action', 'il disparaît', 'il devient complément'], reponse: 0, explication: 'Le vent a renversé l’arbre, actif : le vent fait. L’arbre a été renversé par le vent, passif : l’arbre subit. Les deux phrases disent le même fait, mais ne mettent pas le même élément en avant.' },
      { type: 'qcm', question: 'Comment se construit la voix passive ?', choix: ['être conjugué + participe passé', 'avoir conjugué + participe passé', 'être + infinitif', 'aller + infinitif'], reponse: 0, explication: 'est mangé, a été construit, sera terminé, avait été oublié. Mais attention : être seul ne suffit pas à conclure, comme dans elle est partie.' },
      { type: 'vraifaux', question: '« Elle est partie » est une phrase à la voix passive.', reponse: false, explication: 'Faux. C’est le passé composé du verbe partir, qui se conjugue avec être. Le test de l’agent tranche : « elle est partie par quelqu’un » n’a aucun sens.' },
      { type: 'qcm', question: 'Quel test permet de reconnaître un passif à coup sûr ?', choix: ['peut-on ajouter « par quelqu’un » ?', 'y a-t-il le verbe être ?', 'le verbe est-il au passé ?', 'la phrase est-elle longue ?'], reponse: 0, explication: 'C’est le test de l’agent. Le second test consiste à essayer de retourner la phrase à l’actif : si c’est possible, c’était bien un passif.' },
      { type: 'saisie', question: 'Transforme au passif : « Le vent a renversé l’arbre. »', reponses: ['l’arbre a été renversé par le vent', "l'arbre a été renversé par le vent", 'l’arbre a été renversé par le vent.'], explication: 'Le COD devient sujet, le verbe passe à être + participe au MÊME temps, ici le passé composé, et le sujet devient complément d’agent introduit par par.' },
      { type: 'vraifaux', question: 'Le temps du verbe change quand on passe de l’actif au passif.', reponse: false, explication: 'Faux, il ne change jamais. C’est l’auxiliaire être qui porte le temps : il range → il est rangé ; il rangera → il sera rangé ; il a rangé → il a été rangé.' },
      { type: 'qcm', question: 'Par quoi le complément d’agent est-il introduit ?', choix: ['par, ou plus rarement de', 'de seulement', 'à', 'pour'], reponse: 0, explication: 'par dans le cas ordinaire. de après les verbes de sentiment : aimé de tous, respecté de tous, craint de tous.' },
      { type: 'qcm', question: 'Quelle phrase ne peut PAS se mettre au passif ?', choix: ['Il parle à sa sœur.', 'Les élèves lisent un roman.', 'Le chat mange la souris.', 'Le jury récompense un candidat.'], reponse: 0, explication: 'à sa sœur est un COI, pas un COD. Seuls les verbes ayant un COD peuvent se mettre au passif : sans COD, aucune transformation n’est possible.' },
      { type: 'vraifaux', question: '« Ce sac pèse trois kilos » peut se mettre au passif.', reponse: false, explication: 'Faux. trois kilos ressemble à un COD mais n’en est pas un : il mesure, il ne subit rien. Même cas pour coûter, valoir, mesurer et durer.' },
      { type: 'qcm', question: 'Pourquoi écrit-on « Des erreurs ont été commises » plutôt que « J’ai commis des erreurs » ?', choix: ['pour effacer celui qui fait l’action', 'pour faire plus court', 'pour changer le temps', 'par hasard'], reponse: 0, explication: 'Le passif sans agent permet de ne pas dire par qui, donc de ne pas engager de responsabilité. Devant un tel passif, la question à poser est toujours : par qui ?' },
      { type: 'qcm', question: 'Dans « Le vase est tombé par accident », « par accident » est :', choix: ['un complément circonstanciel', 'un complément d’agent', 'un COD', 'un sujet'], reponse: 0, explication: 'Le test : peut-on en faire le sujet d’une phrase active ? « L’accident a cassé le vase » change le sens. Personne ne fait l’action : c’est un circonstanciel de manière.' },
      { type: 'qcm', question: 'Le participe passé employé seul s’accorde :', choix: ['comme un adjectif, avec le nom qu’il qualifie', 'avec le COD', 'jamais', 'avec le verbe'], reponse: 0, explication: 'Fatiguée, elle s’assit : accord avec elle. Sans être ni avoir devant lui, le participe fonctionne exactement comme un adjectif qualificatif.' },
      { type: 'qcm', question: 'Avec l’auxiliaire être, le participe passé s’accorde avec :', choix: ['le sujet, toujours', 'le COD', 'rien', 'le complément d’agent'], reponse: 0, explication: 'Elle est venue, ils sont arrivés, les lettres ont été envoyées. Cette règle couvre aussi toutes les phrases passives, qui se construisent avec être.' },
      { type: 'vraifaux', question: 'On écrit : Elle a mangée une pomme.', reponse: false, explication: 'Faux. Avec avoir, on n’accorde JAMAIS avec le sujet. Le COD une pomme est placé après le verbe, donc il n’y a aucun accord : elle a mangé. C’est l’erreur la plus fréquente du chapitre.' },
      { type: 'saisie', question: 'Accorde : « Les pommes qu’elle a (manger) ……… étaient vertes. » (un mot)', reponses: ['mangées', 'mangees'], explication: 'Le COD est le pronom relatif qu’, mis pour les pommes, féminin pluriel, et il est placé AVANT le verbe : l’accord se fait donc.' },
      { type: 'qcm', question: 'Avec avoir, quand y a-t-il accord ?', choix: ['si le COD est placé avant le verbe', 'si le sujet est féminin', 'toujours', 'jamais'], reponse: 0, explication: 'Trois questions : y a-t-il un COD ? est-il avant le verbe ? avec quel nom s’accorde-t-il ? Après le verbe ou absent, pas d’accord.' },
      { type: 'qcm', question: 'Dans quels cas le COD passe-t-il devant le verbe ?', choix: ['pronom personnel, pronom relatif que, question', 'jamais', 'quand la phrase est longue', 'quand le verbe est au passé'], reponse: 0, explication: 'il les a vus ; les films que j’ai vus ; quelle robe as-tu choisie ? En dehors de ces trois cas, le COD suit le verbe et le participe reste invariable.' },
      { type: 'saisie', question: 'Accorde : « Il a (dormir) ……… douze heures. » (un mot)', reponses: ['dormi'], explication: 'douze heures est un complément de durée, pas un COD. Sans COD, aucun accord possible : le participe reste invariable.' },
      { type: 'qcm', question: 'Quand l’agent n’est pas exprimé, quel sujet emploie-t-on pour revenir à l’actif ?', choix: ['on', 'il', 'quelqu’un', 'cela'], reponse: 0, explication: 'Le musée a été rénové devient On a rénové le musée. Le pronom on tient exactement la place d’un sujet indéterminé.' },
      { type: 'qcm', question: 'Dans un récit, une accumulation de verbes au passif montre un personnage qui :', choix: ['subit les événements sans les maîtriser', 'agit avec détermination', 'parle beaucoup', 'réfléchit longuement'], reponse: 0, explication: 'Il fut poussé, bousculé, entraîné : le personnage n’est jamais sujet d’une action. L’absence d’agent renforce encore l’effet, les forces qui agissent restant anonymes.' }
    ]
  }
,
  'physique-chimie/L06': {
    ...
    items: [
      { type: 'qcm', question: 'Dans quel sens circule le courant conventionnel à l’extérieur du générateur ?', choix: ['de la borne + vers la borne −', 'de la borne − vers la borne +', 'dans les deux sens', 'cela dépend du récepteur'], reponse: 0, explication: 'C’est une convention fixée avant la découverte de l’électron. Les électrons circulent en réalité dans le sens inverse, mais toute l’électricité s’écrit avec le sens conventionnel.' },
      { type: 'vraifaux', question: 'Le corps humain est un isolant.', reponse: false, explication: 'Faux. Le corps humain est CONDUCTEUR, surtout quand la peau est humide. C’est la raison de toutes les règles de sécurité électrique.' },
      { type: 'qcm', question: 'Dans un circuit en série, que se passe-t-il si on retire une lampe ?', choix: ['tout s’éteint', 'les autres continuent de briller', 'les autres brillent plus fort', 'rien ne change'], reponse: 0, explication: 'La boucle unique est ouverte : plus aucun courant ne circule. C’est pourquoi les anciennes guirlandes s’éteignaient entièrement dès qu’une ampoule grillait.' },
      { type: 'qcm', question: 'En série, que devient l’intensité du courant ?', choix: ['elle est la même en tout point', 'elle se partage entre les dipôles', 'elle augmente à chaque dipôle', 'elle disparaît'], reponse: 0, explication: 'En série, c’est l’INTENSITÉ qui est commune, et la tension qui s’additionne. En dérivation, c’est exactement l’inverse.' },
      { type: 'qcm', question: 'En dérivation, que devient la tension aux bornes de chaque branche ?', choix: ['elle est la même pour toutes', 'elle se partage entre les branches', 'elle est nulle', 'elle double'], reponse: 0, explication: 'En dérivation, c’est la TENSION qui est commune, et l’intensité qui se partage aux nœuds. Chaque grandeur est commune dans un montage et se partage dans l’autre.' },
      { type: 'saisie', question: 'Un générateur de 6 V alimente deux lampes identiques en série. Quelle tension reçoit chaque lampe ? (en volts, chiffre seul)', reponses: ['3', '3 v', '3v'], explication: 'Les tensions s’additionnent en série : 6 ÷ 2 = 3 V chacune. C’est pourquoi deux lampes en série brillent moins qu’une seule sur le même générateur.' },
      { type: 'qcm', question: 'Comment branche-t-on un ampèremètre ?', choix: ['en série, en ouvrant le circuit', 'en dérivation, aux bornes du dipôle', 'hors circuit', 'peu importe'], reponse: 0, explication: 'L’ampèremètre mesure le débit du courant : il doit donc être traversé par lui. On entre par la borne A et on sort par la borne COM.' },
      { type: 'qcm', question: 'Que se passe-t-il si on branche un ampèremètre en dérivation aux bornes d’une pile ?', choix: ['il crée un court-circuit et se détruit', 'il affiche 0', 'il mesure la tension', 'rien de particulier'], reponse: 0, explication: 'Sa résistance est presque nulle : d’après I = U ÷ R, l’intensité devient très grande. C’est l’erreur de manipulation la plus grave du chapitre.' },
      { type: 'qcm', question: 'Comment branche-t-on un voltmètre ?', choix: ['en dérivation, aux bornes du dipôle', 'en série dans le circuit', 'hors circuit', 'sur le fil de terre'], reponse: 0, explication: 'On ne touche pas au circuit : le voltmètre se pose aux bornes du dipôle étudié. Placé en série, sa résistance très grande bloquerait presque tout le courant.' },
      { type: 'saisie', question: 'Quelle est la formule de la loi d’Ohm ? (sous la forme U = ...)', reponses: ['u = r x i', 'u = r × i', 'u=r×i', 'u=rxi', 'u = ri'], explication: 'U = R × I, avec U en volts, R en ohms et I en ampères. Les deux formes dérivées : R = U ÷ I et I = U ÷ R.' },
      { type: 'saisie', question: 'Une résistance de 100 Ω est traversée par 0,05 A. Quelle est la tension ? (en volts, chiffre seul)', reponses: ['5', '5 v', '5v'], explication: 'U = R × I = 100 × 0,05 = 5 V. Vérifie toujours que tes unités sont le volt, l’ohm et l’ampère avant de calculer.' },
      { type: 'qcm', question: 'Une résistance de 150 Ω est traversée par 40 mA. Quelle est la tension ?', choix: ['6 V', '6000 V', '3,75 V', '190 V'], reponse: 0, explication: 'Il faut CONVERTIR d’abord : 40 mA = 0,04 A. Puis U = 150 × 0,04 = 6 V. Sans conversion, on trouverait 6000 V, mille fois trop grand.' },
      { type: 'qcm', question: 'Comment calcule-t-on la puissance électrique ?', choix: ['P = U × I', 'P = U ÷ I', 'P = R × I', 'P = U + I'], reponse: 0, explication: 'P = U × I, avec P en watts, U en volts et I en ampères. L’énergie s’en déduit : E = P × t.' },
      { type: 'saisie', question: 'Un radiateur de 2 kW fonctionne 90 heures. Quelle énergie consomme-t-il ? (en kWh, chiffre seul)', reponses: ['180', '180 kwh'], explication: 'E = P × t = 2 × 90 = 180 kWh. Attention : pour obtenir des kWh, la puissance doit être en KILOWATTS et la durée en HEURES.' },
      { type: 'qcm', question: 'Qu’est-ce qu’un court-circuit ?', choix: ['les deux bornes du générateur reliées sans récepteur', 'un circuit trop court', 'un circuit ouvert', 'un circuit en dérivation'], reponse: 0, explication: 'La résistance devient presque nulle. D’après I = U ÷ R, l’intensité devient très grande : les fils chauffent et un incendie peut se déclarer.' },
      { type: 'qcm', question: 'Que protège un disjoncteur différentiel ?', choix: ['les personnes', 'l’installation', 'le générateur', 'les ampoules'], reponse: 0, explication: 'Il compare le courant entrant et le courant sortant : si une partie fuit vers la terre, à travers un corps par exemple, il coupe dès 30 mA. Le fusible, lui, protège l’installation.' },
      { type: 'saisie', question: 'À partir de quelle intensité, en milliampères, un courant devient-il dangereux pour le corps humain ? (chiffre seul)', reponses: ['30', '30 ma'], explication: '30 mA, soit 0,03 A, traversant la poitrine peut être mortel. Sous 230 V avec une peau humide, ce seuil est atteint immédiatement : c’est pourquoi le différentiel coupe à cette valeur.' },
      { type: 'vraifaux', question: 'On peut remplacer un fusible grillé par un fil de cuivre.', reponse: false, explication: 'Faux, et très dangereux. Un fil de cuivre ne fond pas à l’intensité prévue : la protection disparaît, et rien n’interrompt plus le courant en cas de surintensité.' },
      { type: 'qcm', question: 'Toute l’installation électrique d’un logement est montée :', choix: ['en dérivation', 'en série', 'en série pour l’éclairage, en dérivation pour les prises', 'cela dépend du logement'], reponse: 0, explication: 'C’est pourquoi éteindre une lampe n’éteint pas le réfrigérateur, et qu’une ampoule grillée n’affecte rien d’autre. Un montage en série rendrait l’installation inutilisable.' },
      { type: 'qcm', question: 'Une multiprise supporte 16 A sous 230 V. Quelle puissance maximale peut-elle fournir ?', choix: ['3 680 W', '246 W', '14,4 W', '1 600 W'], reponse: 0, explication: 'P = U × I = 230 × 16 = 3 680 W. Un four, une bouilloire et un fer à repasser totalisent souvent plus de 6 000 W : d’où la règle de ne jamais les cumuler.' }
    ]
  }
,
  'svt/L05': {
    ...
    items: [
      { type: 'qcm', question: 'Quelle est la différence entre un ovaire et un ovule ?', choix: ['l’ovaire est un organe, l’ovule une cellule', 'ce sont deux mots pour la même chose', 'l’ovaire est une cellule, l’ovule un organe', 'l’ovaire est masculin, l’ovule féminin'], reponse: 0, explication: 'Il existe deux ovaires, qui sont des organes. L’ovule est la cellule reproductrice qu’ils contiennent. C’est l’erreur de vocabulaire la plus fréquente du chapitre.' },
      { type: 'vraifaux', question: 'L’ovule est plus gros que le spermatozoïde.', reponse: true, explication: 'Vrai. L’ovule mesure environ 120 µm de diamètre, le spermatozoïde environ 60 µm de long, queue comprise, et il est bien plus fin. L’ovule est la plus grosse cellule du corps humain.' },
      { type: 'qcm', question: 'Quand le stock d’ovules est-il constitué ?', choix: ['avant la naissance', 'à la puberté', 'chaque mois', 'en continu toute la vie'], reponse: 0, explication: 'Contrairement aux spermatozoïdes, produits en continu à partir de la puberté, le stock d’ovules est formé avant la naissance. Un seul est libéré par cycle.' },
      { type: 'saisie', question: 'Combien de temps survivent les spermatozoïdes dans les voies féminines ? (en jours, chiffre seul)', reponses: ['5', '5 jours'], explication: 'Jusqu’à 5 jours, alors que l’ovule ne survit qu’environ 24 heures. C’est cette longue survie qui étend la période fertile bien au-delà du seul jour de l’ovulation.' },
      { type: 'qcm', question: 'Où a lieu la fécondation ?', choix: ['dans le tiers supérieur d’une trompe', 'dans l’utérus', 'dans l’ovaire', 'dans le vagin'], reponse: 0, explication: 'La fécondation se produit dans une trompe. L’embryon ne rejoint l’utérus que quelques jours plus tard, pour la nidation.' },
      { type: 'qcm', question: 'Qu’est-ce qui déclenche la puberté ?', choix: ['des hormones libérées par le cerveau', 'les testicules ou les ovaires seuls', 'l’alimentation', 'la taille du corps'], reponse: 0, explication: 'Tout part du cerveau : il commande aux testicules ou aux ovaires, qui produisent alors la testostérone ou les œstrogènes, lesquelles déclenchent les transformations du corps.' },
      { type: 'qcm', question: 'Quel est le premier jour du cycle féminin, par convention ?', choix: ['le premier jour des règles', 'le jour de l’ovulation', 'le premier jour du mois', 'le dernier jour des règles'], reponse: 0, explication: 'C’est une convention utile : les règles sont le seul événement du cycle facilement observable, contrairement à l’ovulation, qui ne donne aucun signe net.' },
      { type: 'vraifaux', question: 'L’ovulation a toujours lieu au jour 14 du cycle.', reponse: false, explication: 'Faux. Le jour 14 n’est valable que pour un cycle de 28 jours. C’est la seconde phase, après l’ovulation, qui dure régulièrement 14 jours : sur un cycle de 32 jours, l’ovulation a lieu vers le jour 18.' },
      { type: 'saisie', question: 'Une personne a un cycle de 30 jours. Vers quel jour a lieu l’ovulation ? (chiffre seul)', reponses: ['16'], explication: 'On soustrait 14, durée de la phase qui suit l’ovulation : 30 − 14 = jour 16. Cette méthode fonctionne pour toutes les durées de cycle.' },
      { type: 'qcm', question: 'Combien de spermatozoïdes pénètrent dans l’ovule lors de la fécondation ?', choix: ['un seul', 'plusieurs centaines', 'des millions', 'deux'], reponse: 0, explication: 'Un seul. Dès son entrée, la membrane de l’ovule se modifie et bloque tous les autres. Le grand nombre au départ compense les pertes du trajet, il ne sert pas à en faire entrer plusieurs.' },
      ...
      { type: 'qcm', question: 'Que se passe-t-il vers le septième jour après la fécondation ?', choix: ['la nidation', 'la fécondation', 'l’ovulation', 'la naissance'], reponse: 0, explication: 'L’embryon s’implante dans la muqueuse utérine : c’est la nidation. Une grossesse ne commence réellement qu’à ce moment, car beaucoup de cellules-œufs ne s’implantent jamais.' },
      { type: 'qcm', question: 'À partir de quand parle-t-on de fœtus plutôt que d’embryon ?', choix: ['à partir de la 9e semaine', 'à partir du 7e jour', 'à partir du 3e mois de grossesse compté en semaines d’aménorrhée', 'à la naissance'], reponse: 0, explication: 'On parle d’embryon pendant les huit premières semaines, période de mise en place des organes, puis de fœtus jusqu’à la naissance, période de croissance et de maturation.' },
      { type: 'saisie', question: 'Une cellule-œuf se divise 5 fois. Combien de cellules obtient-on ? (chiffre seul)', reponses: ['32'], explication: 'Le nombre double à chaque division : 2, 4, 8, 16, 32. Toutes ces cellules possèdent exactement la même information génétique, celle de la cellule-œuf.' },
      { type: 'vraifaux', question: 'Les sangs de la mère et du fœtus se mélangent dans le placenta.', reponse: false, explication: 'Faux, ils ne se mélangent jamais. Les échanges se font à travers une paroi très fine : dioxygène et nutriments vers le fœtus, dioxyde de carbone et déchets vers la mère.' },
      { type: 'vraifaux', question: 'Le placenta filtre toutes les substances nocives.', reponse: false, explication: 'Faux. L’alcool, la nicotine, de nombreux médicaments et certains virus le traversent et atteignent le fœtus. Les recommandations faites pendant la grossesse découlent directement de cette perméabilité.' },
      { type: 'qcm', question: 'Sur quoi agit la pilule contraceptive ?', choix: ['elle empêche l’ovulation', 'elle empêche la rencontre des cellules', 'elle empêche la nidation', 'elle protège des infections'], reponse: 0, explication: 'Par un apport d’hormones, elle bloque la commande venue du cerveau. Le préservatif, lui, empêche la rencontre des cellules ; le dispositif intra-utérin empêche surtout la nidation.' },
      { type: 'qcm', question: 'Quelle méthode protège à la fois de la grossesse et des infections sexuellement transmissibles ?', choix: ['le préservatif', 'la pilule', 'l’implant', 'le dispositif intra-utérin'], reponse: 0, explication: 'C’est la seule, parce qu’elle agit comme une barrière physique. Les autres méthodes agissent sur l’ovulation ou la nidation, ce qui n’a aucun rapport avec la transmission d’une infection.' },
      { type: 'vraifaux', question: 'Si l’on n’a aucun symptôme, on n’a pas d’infection sexuellement transmissible.', reponse: false, explication: 'Faux. Beaucoup d’IST sont asymptomatiques : une infection à chlamydia passe très souvent inaperçue, se transmet malgré tout et peut avoir des conséquences durables. Seul le dépistage permet de le savoir.' },
      { type: 'qcm', question: 'Pourquoi la reproduction sexuée est-elle un avantage pour une espèce ?', choix: ['elle produit des individus tous différents', 'elle est plus rapide', 'elle demande moins d’énergie', 'elle produit plus de descendants'], reponse: 0, explication: 'Cette diversité permet à certains individus de résister à un changement de milieu ou à une maladie. Si tous étaient identiques, un seul agent pathogène pourrait les éliminer tous.' }
    ]
  }
,
  'histoire-geo/H5': {
...
,
  'histoire-geo/G4': {
    ...
    items: [
      { type: 'qcm', question: 'Quelle est la différence entre un touriste et un excursionniste ?', choix: ['le touriste passe au moins une nuit sur place', 'le touriste voyage à l’étranger', 'le touriste voyage en avion', 'il n’y a aucune différence'], reponse: 0, explication: 'L’excursionniste rentre dormir chez lui le soir même. La distinction compte pour les politiques de régulation : l’excursionniste dépense peu tout en contribuant à la saturation.' },
      { type: 'vraifaux', question: 'Un séjour professionnel de trois jours compte comme du tourisme.', reponse: true, explication: 'Vrai. Le tourisme d’affaires représente environ un séjour sur cinq dans le monde. Réduire le tourisme aux vacances fausse toutes les statistiques, notamment pour des villes comme Francfort ou Genève.' },
      { type: 'qcm', question: 'Combien d’arrivées touristiques internationales compte-t-on par an ?', choix: ['environ 1,4 milliard', 'environ 140 millions', 'environ 14 milliards', 'environ 400 millions'], reponse: 0, explication: 'Mais attention : une même personne qui visite trois pays compte pour trois arrivées. Ce chiffre mesure des passages de frontière, pas des individus.' },
      { type: 'vraifaux', question: 'Le chiffre de 1,4 milliard d’arrivées correspond à 1,4 milliard de personnes.', reponse: false, explication: 'Faux. Une personne visitant l’Italie, l’Autriche et l’Allemagne au cours d’un même voyage compte pour trois arrivées. Le nombre réel de voyageurs est donc nettement inférieur.' },
      { type: 'saisie', question: 'Quelle part du PIB mondial le tourisme représente-t-il ? (en pourcentage, chiffre seul)', reponses: ['10', '10 %', '10%'], explication: 'Environ 10 %, et il emploie environ une personne sur dix dans le monde. C’est l’une des premières activités économiques de la planète.' },
      { type: 'qcm', question: 'Le tourisme interne, à l’intérieur de son propre pays, est :', choix: ['environ six fois plus important que l’international', 'deux fois moins important', 'équivalent', 'négligeable'], reponse: 0, explication: 'Environ six milliards de séjours par an. L’oublier fausse toute comparaison, exactement comme pour les migrations internes.' },
      { type: 'qcm', question: 'Quelle part des humains n’a jamais pris l’avion ?', choix: ['environ 80 %', 'environ 20 %', 'environ 50 %', 'environ 5 %'], reponse: 0, explication: 'Le tourisme international reste le fait d’une minorité. Parler de « tourisme de masse » ne signifie donc pas que la masse des humains voyage.' },
      { type: 'qcm', question: 'Quelle région concentre la moitié des arrivées mondiales ?', choix: ['l’Europe', 'l’Asie-Pacifique', 'les Amériques', 'l’Afrique'], reponse: 0, explication: 'Environ 50 % des arrivées sur 7 % des terres émergées. Viennent ensuite l’Asie-Pacifique avec 25 %, les Amériques avec 15 %, l’Afrique et le Moyen-Orient avec 5 % chacun.' },
      { type: 'saisie', question: 'Quel pays reçoit le plus d’arrivées touristiques au monde ?', reponses: ['la france', 'france'], explication: 'Environ 90 millions d’arrivées par an, grâce à sa position de carrefour, à la diversité de ses paysages et à son patrimoine. Elle n’est cependant que troisième pour les recettes.' },
      { type: 'qcm', question: 'Pourquoi la France n’est-elle que troisième pour les recettes touristiques ?', choix: ['les séjours y sont courts et beaucoup de visiteurs la traversent', 'ses hôtels sont trop chers', 'elle reçoit peu de visiteurs', 'elle ne compte pas le tourisme d’affaires'], reponse: 0, explication: 'Arrivées et recettes sont deux indicateurs différents. Comparer deux pays demande toujours de préciser lequel on regarde.' },
      { type: 'qcm', question: 'Quelles sont les trois conditions qui font un espace touristique ?', choix: ['un atout, une accessibilité, des équipements', 'un atout, du soleil, une plage', 'des hôtels, des restaurants, des magasins', 'une ville, une gare, un musée'], reponse: 0, explication: 'Un atout sans accès ni équipement ne produit aucun tourisme. Un village de montagne avec un lac remarquable mais sans route ni hébergement n’est pas un espace touristique.' },
      { type: 'vraifaux', question: 'Le tourisme se contente d’occuper des espaces existants.', reponse: false, explication: 'Faux, il les PRODUIT. La Grande-Motte, Cancún ou Benidorm ont été bâties sur des terrains presque vides : ces stations n’existaient pas avant qu’on les construise.' },
      { type: 'qcm', question: 'Quelles sont les quatre phases du cycle de vie d’une station ?', choix: ['découverte, développement, maturité, déclin ou renouvellement', 'création, croissance, stabilité, fermeture', 'projet, chantier, ouverture, agrandissement', 'hiver, printemps, été, automne'], reponse: 0, explication: 'Ce modèle explique pourquoi les stations investissent en pleine réussite : attendre le déclin, c’est investir trop tard. Le déclin n’a rien d’automatique.' },
      { type: 'qcm', question: 'Quelle part des nuitées annuelles françaises se fait en juillet et août ?', choix: ['plus de 40 %', 'environ 15 %', 'environ 25 %', 'plus de 70 %'], reponse: 0, explication: 'Cette concentration dans le temps se cumule à la concentration dans l’espace, sur des littoraux étroits et quelques centres-villes. Ce sont les deux ensemble qui produisent la saturation.' },
      { type: 'vraifaux', question: 'Le surtourisme est d’abord un problème de nombre total de visiteurs.', reponse: false, explication: 'Faux. Vingt millions de visiteurs répartis sur toute l’année et sur un territoire large ne satureraient rien. C’est la CONCENTRATION qui pose problème : d’où des politiques qui visent à étaler plutôt qu’à interdire.' },
      { type: 'qcm', question: 'Combien Venise reçoit-elle de visiteurs par an, pour environ 50 000 habitants dans la ville historique ?', choix: ['environ 20 millions', 'environ 2 millions', 'environ 200 000', 'environ 100 millions'], reponse: 0, explication: 'Soit 400 visiteurs par habitant et par an. La population de la ville historique a été divisée par trois depuis les années 1950, en grande partie parce que les logements sont loués aux touristes.' },
      { type: 'qcm', question: 'Un touriste consomme en moyenne combien de fois plus d’eau qu’un habitant de la même région ?', choix: ['trois à quatre fois plus', 'autant', 'dix fois plus', 'deux fois moins'], reponse: 0, explication: 'Piscines, arrosage, hôtellerie. En période de sécheresse, restreindre uniquement l’arrosage des jardins des habitants fait donc porter l’effort sur ceux qui consomment le moins.' },
      { type: 'qcm', question: 'Dans une destination lointaine, quelle part du prix d’un séjour reste souvent sur place ?', choix: ['20 à 30 %', '80 à 90 %', 'la totalité', 'moins de 1 %'], reponse: 0, explication: 'Le reste revient à la compagnie aérienne, au voyagiste et à la chaîne hôtelière, tous étrangers. Choisir un hébergement et des guides locaux change réellement la part qui reste sur le territoire.' },
      { type: 'qcm', question: 'Un tourisme durable doit être à la fois :', choix: ['viable économiquement, acceptable socialement, supportable pour l’environnement', 'peu cher, rapide et confortable', 'local, gratuit et hors saison', 'le moins fréquenté possible'], reponse: 0, explication: 'Les trois exigences ensemble. Un hôtel écologique rempli de clients venus en avion de l’autre bout du monde ne rend pas un séjour durable : c’est l’ensemble du voyage qu’il faut évaluer.' },
      { type: 'qcm', question: 'Des tarifs réduits en novembre dans une station balnéaire agissent sur :', choix: ['la période de fréquentation', 'le nombre total de visiteurs', 'le lieu visité', 'le prix du logement'], reponse: 0, explication: 'C’est un étalement dans le temps. Mettre en valeur un site secondaire étale dans l’espace ; une réservation obligatoire agit sur le nombre ; un plafonnement des locations agit sur le comportement.' }
    ]
  }
,
  'emc/L02': {
    ...
    items: [
      { type: 'qcm', question: 'Quelle est la différence entre égalité de droit et égalité réelle ?', choix: ['la première est la même loi pour tous, la seconde les moyens d’en user', 'ce sont deux mots pour la même chose', 'la première concerne les revenus', 'la seconde n’existe pas en droit'], reponse: 0, explication: 'La loi garantit à tous le droit de se présenter à un concours : c’est l’égalité de droit. Mais sans ordinateur, sans manuels et sans accompagnement, les chances ne sont pas les mêmes : l’égalité réelle n’est pas atteinte.' },
      { type: 'qcm', question: 'L’égalité des chances porte sur :', choix: ['les conditions de départ', 'les résultats obtenus', 'les revenus de chacun', 'les diplômes'], reponse: 0, explication: 'Elle vise à rendre les chances de départ comparables, pas à ce que tout le monde obtienne le même résultat. Confondre les deux rend impossible toute discussion sur le sujet.' },
      { type: 'vraifaux', question: 'L’égalité exige que tout le monde soit traité exactement de la même façon.', reponse: false, explication: 'Faux. Le principe juridique est de traiter identiquement des situations identiques, et différemment des situations différentes, si c’est justifié et proportionné. Une bourse ou un aménagement d’examen servent l’égalité, ils ne la rompent pas.' },
      { type: 'qcm', question: 'Combien de conditions faut-il réunir pour qu’il y ait discrimination au sens juridique ?', choix: ['trois', 'une', 'deux', 'cinq'], reponse: 0, explication: 'Un traitement défavorable ; fondé sur un critère figurant dans la liste légale ; dans un domaine couvert par la loi. Si une seule manque, ce n’est pas une discrimination au sens juridique.' },
      { type: 'vraifaux', question: 'Toute injustice est une discrimination.', reponse: false, explication: 'Faux. Ne pas être retenu parce qu’un autre candidat était plus expérimenté est défavorable, mais fondé sur un critère licite. Le droit ne sanctionne que les traitements reposant sur les critères qu’il a listés.' },
      { type: 'qcm', question: 'Lequel de ces critères n’est PAS reconnu par la loi française ?', choix: ['la préférence sportive', 'le lieu de résidence', 'la grossesse', 'la précarité économique'], reponse: 0, explication: 'Écarter quelqu’un pour son équipe favorite est absurde, mais ce critère ne figure pas dans la liste légale. Le lieu de résidence y a été ajouté en 2014, la précarité économique en 2016.' },
      { type: 'saisie', question: 'Combien de critères de discrimination la loi française reconnaît-elle aujourd’hui, environ ? (chiffre seul)', reponses: ['20', 'vingt', '25', '26'], explication: 'Plus de vingt, et la liste s’allonge à mesure que des situations sont reconnues. Le droit n’est pas figé : il se construit.' },
      { type: 'qcm', question: 'Une annonce d’emploi précisant « moins de 30 ans » est :', choix: ['une discrimination directe', 'une discrimination indirecte', 'une différence licite', 'une simple maladresse'], reponse: 0, explication: 'Traitement défavorable, critère de l’âge présent dans la liste, domaine de l’emploi couvert : les trois conditions sont réunies, et le critère est énoncé ouvertement.' },
      { type: 'qcm', question: 'Une exigence de taille minimale de 1,80 m pour un poste de vendeur est :', choix: ['une discrimination indirecte', 'une discrimination directe', 'parfaitement licite', 'une exigence professionnelle essentielle'], reponse: 0, explication: 'La règle est neutre en apparence mais écarte en pratique une large part des femmes, sans qu’aucune nécessité du poste ne le justifie.' },
      { type: 'vraifaux', question: 'Il ne peut y avoir discrimination que s’il y a intention de nuire.', reponse: false, explication: 'Faux. Le droit regarde l’EFFET, pas l’intention. Une règle peut être discriminatoire alors que celui qui l’a posée n’y voyait aucun mal : c’est tout l’intérêt de la notion de discrimination indirecte.' },
      { type: 'qcm', question: 'Un tarif réduit pour les moins de 26 ans dans un musée est :', choix: ['une différence de traitement licite', 'une discrimination fondée sur l’âge', 'une discrimination indirecte', 'interdit par la loi'], reponse: 0, explication: 'La différence de situation économique est réelle, la mesure est en rapport avec elle et elle est favorable, donc proportionnée. Traiter différemment des situations différentes est licite.' },
      { type: 'qcm', question: 'Refuser l’entrée à une personne aveugle accompagnée de son chien guide, au nom d’une interdiction des animaux, est :', choix: ['une discrimination indirecte', 'licite, la règle est neutre', 'une discrimination directe', 'sans qualification juridique'], reponse: 0, explication: 'La règle semble neutre mais désavantage en pratique les personnes handicapées, sans nécessité. La loi impose d’ailleurs expressément une exception pour les chiens guides et d’assistance.' },
      { type: 'qcm', question: 'Quelle peine encourt une personne physique pour discrimination ?', choix: ['trois ans d’emprisonnement et 45 000 € d’amende', 'une simple amende de 135 €', 'aucune, c’est une règle morale', 'dix ans d’emprisonnement'], reponse: 0, explication: 'La discrimination est un délit puni par le code pénal, avec des peines aggravées dans certains cas. Ce n’est donc pas une simple règle morale.' },
      { type: 'qcm', question: 'Quelle est la première étape d’un recours face à une discrimination ?', choix: ['rassembler des preuves', 'porter plainte', 'saisir le Défenseur des droits', 'quitter son emploi'], reponse: 0, explication: 'Les preuves disparaissent vite : une annonce est retirée, un courriel effacé, un témoin s’en va. Sans éléments, même l’aménagement de la charge de la preuve ne peut pas jouer.' },
      { type: 'qcm', question: 'Qu’est-ce que le Défenseur des droits ?', choix: ['une autorité indépendante saisissable gratuitement', 'un avocat d’État', 'un tribunal spécialisé', 'un service du ministère de la Justice'], reponse: 0, explication: 'Créé en 2011, il est saisissable sans avocat ni formalité. Il enquête, peut exiger des documents et publie des décisions qui font autorité, mais il ne juge pas.' },
      { type: 'vraifaux', question: 'La victime d’une discrimination doit apporter la preuve complète de ce qu’elle avance.', reponse: false, explication: 'Faux. Elle présente des éléments qui LAISSENT SUPPOSER une discrimination ; c’est ensuite à l’auteur de prouver que sa décision reposait sur des éléments objectifs étrangers. Les preuves sont presque toujours détenues par celui qui décide.' },
      { type: 'qcm', question: 'Quelle juridiction juge les litiges entre un salarié et son employeur ?', choix: ['le conseil de prud’hommes', 'le tribunal administratif', 'la cour d’assises', 'le Conseil constitutionnel'], reponse: 0, explication: 'Le conseil de prud’hommes. Le tribunal judiciaire juge les litiges civils et les délits, dont la discrimination, qui est pénalement sanctionnée.' },
      { type: 'qcm', question: 'Que mesure l’index de l’égalité professionnelle ?', choix: ['les écarts entre femmes et hommes dans une entreprise', 'le nombre de salariés', 'les bénéfices de l’entreprise', 'la satisfaction au travail'], reponse: 0, explication: 'Cinq points : écart de rémunération, d’augmentations, de promotions, retour de congé maternité, part des femmes parmi les dix plus hautes rémunérations. Il ne change aucun salaire : il rend les écarts visibles, ce qui est la condition pour agir.' },
      { type: 'vraifaux', question: 'Les politiques d’égalité créent des privilèges.', reponse: false, explication: 'Faux. Une obligation d’emploi ou une règle de parité corrige un écart constaté et mesuré. Le débat légitime porte sur leur efficacité et leur durée, pas sur leur principe, qui découle de l’égalité des chances.' },
      { type: 'qcm', question: 'Quelles sont les trois questions à se poser devant une différence de traitement ?', choix: ['les situations diffèrent-elles, le traitement est-il en rapport, est-il proportionné', 'qui décide, quand, pourquoi', 'est-ce légal, est-ce moral, est-ce utile', 'combien, où, comment'], reponse: 0, explication: 'Trois oui signifient qu’il n’y a pas de discrimination. Ces trois conditions figurent dans la loi : elles ne sont pas laissées à l’appréciation de chacun.' }
    ]
  }
,
  'emc/L03': {
    ...
    items: [
      { type: 'qcm', question: 'Quelle est la différence entre la justice civile et la justice pénale ?', choix: ['la civile répare un litige, la pénale punit une infraction', 'la civile juge les adultes, la pénale les mineurs', 'la civile est gratuite, la pénale payante', 'il n’y a aucune différence'], reponse: 0, explication: 'Un même fait peut relever des deux : un conducteur qui blesse un piéton est poursuivi au pénal pour être puni, et le piéton demande réparation au civil ou en se constituant partie civile.' },
      { type: 'qcm', question: 'Qui représente la société dans un procès pénal ?', choix: ['le procureur de la République', 'la victime', 'l’avocat', 'le greffier'], reponse: 0, explication: 'Le procureur défend l’intérêt général, pas la victime. Celle-ci doit se constituer partie civile pour obtenir réparation, et peut être assistée de son propre avocat.' },
      { type: 'saisie', question: 'Dans quel texte de 1789 figure la présomption d’innocence ? (nom du texte)', reponses: ['la déclaration des droits de l’homme et du citoyen', 'déclaration des droits de l’homme et du citoyen', 'la déclaration des droits de l’homme', 'déclaration des droits de l’homme'], explication: 'À l’article 9. Conséquence : c’est à l’accusation de prouver la culpabilité, jamais à la personne poursuivie de prouver son innocence.' },
      { type: 'vraifaux', question: 'La présomption d’innocence ne vaut que devant le tribunal.', reponse: false, explication: 'Faux. Elle interdit aussi de présenter publiquement comme coupable une personne non jugée. C’est pourquoi les médias écrivent « le suspect » ou « la personne mise en examen ».' },
      { type: 'qcm', question: 'Quelle juridiction juge les contraventions ?', choix: ['le tribunal de police', 'le tribunal correctionnel', 'la cour d’assises', 'le tribunal judiciaire'], reponse: 0, explication: 'Contravention au tribunal de police, délit au tribunal correctionnel, crime à la cour d’assises ou à la cour criminelle départementale.' },
      { type: 'qcm', question: 'Un vol est :', choix: ['un délit', 'une contravention', 'un crime', 'cela dépend de la victime'], reponse: 0, explication: 'C’est la LOI qui classe une infraction, pas la victime ni le juge. Un vol simple est un délit, jugé par le tribunal correctionnel ; un vol avec arme est un crime.' },
      { type: 'qcm', question: 'Que signifie « pas d’infraction, pas de peine sans loi » ?', choix: ['la loi définit à l’avance les infractions et les peines', 'la loi change après chaque procès', 'le juge peut inventer une peine', 'les peines sont décidées par la victime'], reponse: 0, explication: 'C’est la légalité des délits et des peines, une garantie contre l’arbitraire : chacun sait à l’avance ce qui est interdit et ce qu’il risque.' },
      { type: 'qcm', question: 'Quelle est la juridiction suprême de l’ordre administratif ?', choix: ['le Conseil d’État', 'la Cour de cassation', 'le Conseil constitutionnel', 'la cour d’appel'], reponse: 0, explication: 'L’ordre administratif juge les litiges entre un particulier et l’administration. L’ordre judiciaire, avec la Cour de cassation à son sommet, juge les litiges privés et les infractions.' },
      { type: 'qcm', question: 'Que fait le Conseil constitutionnel ?', choix: ['il vérifie que les lois sont conformes à la Constitution', 'il juge les crimes les plus graves', 'il juge les litiges avec l’administration', 'il conseille le gouvernement'], reponse: 0, explication: 'Il ne juge pas d’affaires individuelles. Il peut être saisi avant la promulgation d’une loi, ou en cours de procès par une question prioritaire de constitutionnalité.' },
      { type: 'vraifaux', question: 'La Cour de cassation rejuge l’affaire une troisième fois.', reponse: false, explication: 'Faux. Elle juge les DÉCISIONS, pas les affaires : elle vérifie que la loi a été correctement appliquée. Si ce n’est pas le cas, elle casse et renvoie devant une autre cour d’appel.' },
      { type: 'qcm', question: 'Combien de jurés siègent à la cour d’assises en première instance ?', choix: ['six', 'trois', 'douze', 'aucun'], reponse: 0, explication: 'Six jurés citoyens aux côtés de trois magistrats professionnels. Les jurés sont tirés au sort sur les listes électorales : être juré est une obligation civique.' },
      { type: 'qcm', question: 'Quelle juridiction juge les litiges entre un salarié et son employeur ?', choix: ['le conseil de prud’hommes', 'le tribunal de commerce', 'le tribunal correctionnel', 'le juge aux affaires familiales'], reponse: 0, explication: 'Il est composé de conseillers élus, moitié salariés moitié employeurs, et commence toujours par une phase de conciliation avant de juger.' },
      { type: 'qcm', question: 'Qui parle en dernier à l’audience pénale ?', choix: ['le prévenu', 'le procureur', 'l’avocat de la partie civile', 'le juge'], reponse: 0, explication: 'C’est une garantie découlant des droits de la défense : la personne dont la liberté est en jeu ne peut pas être laissée sans réponse après l’accusation. Cet ordre est imposé par la loi.' },
      { type: 'vraifaux', question: 'Si une personne garde le silence en garde à vue, cela prouve qu’elle a quelque chose à cacher.', reponse: false, explication: 'Faux. Le silence ne vaut pas aveu et ne peut jamais être retenu contre elle. Ce droit protège surtout les personnes vulnérables ou mal informées, qui pourraient s’accuser à tort sous la pression.' },
      { type: 'qcm', question: 'Qu’est-ce que le principe du contradictoire ?', choix: ['chaque partie peut connaître et discuter les éléments de l’autre', 'les juges débattent entre eux', 'l’accusé peut contredire le juge', 'les débats sont publics'], reponse: 0, explication: 'Aucune preuve ne peut être retenue si la défense n’a pas pu en prendre connaissance et la contester. C’est l’un des droits les plus fondamentaux de la procédure.' },
      { type: 'qcm', question: 'À partir de quel âge une peine peut-elle être prononcée contre un mineur ?', choix: ['13 ans', '10 ans', '16 ans', '18 ans'], reponse: 0, explication: 'En dessous de 13 ans, seules des mesures éducatives sont possibles. De 13 à 18 ans, une peine est possible mais réduite de moitié par l’excuse de minorité.' },
      { type: 'saisie', question: 'Comment appelle-t-on la réduction de peine accordée à un mineur ? (trois mots)', reponses: ['excuse de minorité', 'l’excuse de minorité'], explication: 'Elle réduit la peine de moitié. Entre 16 et 18 ans, elle peut exceptionnellement être écartée, par une décision spécialement motivée.' },
      { type: 'qcm', question: 'Qu’est-ce que l’aide juridictionnelle ?', choix: ['la prise en charge des frais par l’État pour les ressources modestes', 'un conseil gratuit par téléphone', 'une réduction de peine', 'une aide aux victimes seulement'], reponse: 0, explication: 'Elle rend effectif le principe d’égalité devant la justice : sans elle, l’accès au juge dépendrait des moyens financiers de chacun.' },
      { type: 'qcm', question: 'Quelle est la différence entre la peine encourue et la peine prononcée ?', choix: ['l’encourue est le maximum légal, la prononcée ce que le juge décide', 'ce sont deux mots pour la même chose', 'l’encourue est décidée par la victime', 'la prononcée est toujours le maximum'], reponse: 0, explication: 'La peine prononcée est presque toujours inférieure au maximum, parce que le juge tient compte des circonstances et de la personnalité. Ce n’est pas un dysfonctionnement.' },
      { type: 'qcm', question: 'Pourquoi la justice n’est-elle pas la vengeance ?', choix: ['elle est rendue par un tiers, selon une procédure, avec un recours possible', 'elle est plus sévère', 'elle est plus rapide', 'elle coûte moins cher'], reponse: 0, explication: 'La vengeance est exercée par la victime, sans limite et sans contrôle. Le tiers, la procédure et le recours sont ce qui rend la justice acceptable pour tous, y compris pour le condamné.' }
    ]
  }
,
  'anglais-lv1/L06': {
    ...
    items: [
      { type: 'qcm', question: 'Quelle expression est correcte ?', choix: ['In my opinion', 'To my opinion', 'At my opinion', 'On my opinion'], reponse: 0, explication: 'La préposition est in : in my opinion, in my view. C’est une expression figée, et l’erreur to my opinion vient du calque du français.' },
      { type: 'vraifaux', question: 'On peut écrire : In my opinion, I think that it is useful.', reponse: false, explication: 'Faux, c’est redondant. On choisit l’expression d’opinion OU le verbe d’opinion, jamais les deux dans la même phrase.' },
      { type: 'qcm', question: 'Comment traduit-on « je pense qu’il n’a pas raison » ?', choix: ['I don’t think he is right.', 'I think he isn’t right.', 'I think not he is right.', 'I don’t think he isn’t right.'], reponse: 0, explication: 'L’anglais déplace la négation sur le VERBE D’OPINION, contrairement au français. C’est l’un des rares points où l’anglais est moins direct que le français.' },
      { type: 'vraifaux', question: 'On écrit : I am agree with you.', reponse: false, explication: 'Faux. On dit I agree with you : agree est un VERBE, pas un adjectif. L’erreur vient du français « je suis d’accord ».' },
      { type: 'qcm', question: 'Complète : We stayed at home ……… the rain.', choix: ['because of', 'because', 'since', 'so'], reponse: 0, explication: 'because of est suivi d’un NOM, because est suivi d’une proposition avec sujet et verbe. On ne dit jamais because the rain.' },
      { type: 'qcm', question: 'Complète : We stayed at home ……… it was raining.', choix: ['because', 'because of', 'despite', 'in spite of'], reponse: 0, explication: 'La suite est une proposition complète, sujet et verbe : c’est donc because. Avec un nom, on emploierait because of.' },
      { type: 'qcm', question: 'Complète : ……… the rain, we went out.', choix: ['Despite', 'Although', 'Because', 'However'], reponse: 0, explication: 'despite est suivi d’un NOM ou d’une forme en -ing. although est suivi d’une proposition : Although it was raining, we went out.' },
      { type: 'qcm', question: 'Complète : ……… it was raining, we went out.', choix: ['Although', 'Despite', 'In spite of', 'Because of'], reponse: 0, explication: 'La suite est une proposition, donc although ou even though. C’est exactement la même logique que because et because of.' },
      { type: 'vraifaux', question: 'On peut écrire : Although it’s expensive, but it’s useful.', reponse: false, explication: 'Faux. Un seul connecteur d’opposition par phrase : soit Although en tête, soit but au milieu. Le français tolère parfois cette redondance, l’anglais non.' },
      { type: 'qcm', question: 'Comment répond-on « moi aussi » à « I love winter » ?', choix: ['So do I.', 'Neither do I.', 'Me too do I.', 'So I do.'], reponse: 0, explication: 'Après une affirmative : So do I. Après une négative : Neither do I. L’auxiliaire reprend celui de la phrase précédente et passe AVANT le sujet.' },
      { type: 'saisie', question: 'Comment répond-on « moi non plus » à « I don’t like horror films » ? (trois mots)', reponses: ['neither do i', 'neither do i.'], explication: 'Neither do I. Après une phrase négative, on emploie neither, et l’auxiliaire passe avant le sujet.' },
      { type: 'qcm', question: 'Quelle question est correcte pour demander un avis ?', choix: ['What do you think about it?', 'How do you think about it?', 'What do you think it?', 'How you think about it?'], reponse: 0, explication: 'How demanderait de quelle MANIÈRE on pense, ce qui n’a pas de sens. Le français « comment trouves-tu ? » ne se traduit pas mot à mot.' },
      { type: 'qcm', question: 'Où se place « probably » ?', choix: ['au milieu, après l’auxiliaire', 'en tête de phrase', 'en fin de phrase', 'avant le sujet'], reponse: 0, explication: 'It will probably rain. En revanche, maybe et perhaps se placent en TÊTE de phrase : Maybe you’re right.' },
      { type: 'qcm', question: 'Quel connecteur introduit une conséquence en tête de phrase ?', choix: ['Therefore', 'Because', 'Although', 'Despite'], reponse: 0, explication: 'Therefore ou That’s why en tête ; so au milieu. En anglais écrit soigné, on évite de commencer une phrase par So.' },
      { type: 'qcm', question: 'Comment exprime-t-on un désaccord poli ?', choix: ['I see your point, but ...', 'You are wrong.', 'No.', 'That’s stupid.'], reponse: 0, explication: 'Le désaccord poli se construit en trois temps : reconnaître, opposer, justifier. Reconnaître d’abord ce que dit l’autre rend le désaccord recevable.' },
      { type: 'qcm', question: 'Où se place « also » dans une phrase ?', choix: ['au milieu, avant le verbe principal', 'en tête de phrase', 'en fin de phrase', 'avant le sujet'], reponse: 0, explication: 'It is also cheaper. I also think so. En tête de phrase, on emploie Moreover ou In addition.' },
      { type: 'qcm', question: 'Quelle est la différence entre « for example » et « such as » ?', choix: ['such as introduit directement des noms', 'ils sont interchangeables', 'for example introduit des noms', 'such as introduit une phrase'], reponse: 0, explication: 'fruits such as apples and pears. Avec for example, on emploie une phrase ou une incise après virgule : Many fruits, for example apples, ...' },
      { type: 'qcm', question: 'Quelles sont les quatre étapes d’un paragraphe argumentatif ?', choix: ['annoncer, argument avec raison, argument avec exemple, objection et conclusion', 'introduction, développement, exemple, résumé', 'question, réponse, exemple, avis', 'opinion, opinion, opinion, conclusion'], reponse: 0, explication: 'Reconnaître une objection avant de conclure est ce qui distingue un vrai raisonnement d’une simple affirmation répétée.' },
      { type: 'qcm', question: 'Dans « Since it is raining, we’ll stay in », que signifie « since » ?', choix: ['puisque', 'depuis', 'pendant', 'jusqu’à'], reponse: 0, explication: 'Ici c’est le sens de raison. Suivi d’une date ou d’un événement passé, since signifie « depuis » : I have lived here since 2019.' },
      { type: 'vraifaux', question: 'Nuancer son avis, c’est l’affaiblir.', reponse: false, explication: 'Faux. Un avis nuancé est un avis EXACT. Dire I’m sure quand on n’est pas sûr expose à être contredit d’un mot, et la nuance est valorisée à l’oral comme à l’écrit.' }
    ]
  }
,
  'espagnol-lv2/L06': {
    ...
    items: [
      { type: 'qcm', question: 'Quel temps raconte les actions qui font avancer l’histoire ?', choix: ['l’indefinido', 'l’imperfecto', 'le pretérito perfecto', 'le présent'], reponse: 0, explication: 'L’indefinido est le premier plan : événements ponctuels, uniques. L’imperfecto est l’arrière-plan : descriptions, habitudes, états, actions en cours.' },
      { type: 'saisie', question: 'Conjugue « hablar » à l’indefinido, 1re personne du singulier.', reponses: ['hablé'], explication: 'hablé, avec accent sur le e. Attention : hablo sans accent est le présent, et habló avec accent sur le o est la 3e personne de l’indefinido.' },
      { type: 'qcm', question: 'Que signifie « habló » ?', choix: ['il a parlé', 'je parle', 'j’ai parlé', 'il parlait'], reponse: 0, explication: 'L’accent sur le o marque la 3e personne de l’indefinido. Sans accent, hablo est le présent à la 1re personne. Un accent change à la fois le temps et la personne.' },
      { type: 'saisie', question: 'Donne la 1re personne de l’indefinido de « tener ».', reponses: ['tuve'], explication: 'tuve, sans aucun accent. C’est le repère des irréguliers : leurs terminaisons -e, -iste, -o, -imos, -isteis, -ieron ne portent jamais d’accent.' },
      { type: 'saisie', question: 'Donne la 1re personne de l’indefinido de « hacer ».', reponses: ['hice'], explication: 'hice. Attention à la 3e personne : hizo, avec un z, car le c devient z devant o pour conserver le son.' },
      { type: 'qcm', question: 'Quelle est la forme correcte : « ils ont dit » ?', choix: ['dijeron', 'dijieron', 'decieron', 'dijaron'], reponse: 0, explication: 'Quand le radical finit par j, la terminaison perd le i : dijeron, trajeron. La même règle vaut pour tous les radicaux en j.' },
      { type: 'vraifaux', question: '« Fui » peut signifier à la fois « je suis allé » et « j’ai été ».', reponse: true, explication: 'Vrai : ser et ir ont exactement la même forme à l’indefinido. Seul le contexte tranche, et il suffit presque toujours : une préposition a suivie d’un lieu indique ir.' },
      { type: 'qcm', question: 'Combien l’imperfecto compte-t-il d’irréguliers ?', choix: ['trois', 'dix', 'aucun', 'une vingtaine'], reponse: 0, explication: 'ser → era, ir → iba, ver → veía. Il n’y en a aucun autre : c’est le temps le plus régulier de l’espagnol.' },
      { type: 'saisie', question: 'Conjugue « ser » à l’imperfecto, 1re personne du singulier.', reponses: ['era'], explication: 'era. Attention : cette forme est aussi celle de la 3e personne. Quand le contexte ne suffit pas, on exprime le pronom sujet : yo era, él era.' },
      { type: 'qcm', question: 'Complète : Cuando era pequeña, ……… a la playa todos los veranos.', choix: ['iba', 'fui', 'he ido', 'voy'], reponse: 0, explication: 'todos los veranos marque une HABITUDE : l’imperfecto s’impose. fui décrirait un déplacement unique.' },
      { type: 'qcm', question: 'Complète : Mientras ………, sonó el teléfono.', choix: ['leía', 'leí', 'he leído', 'leo'], reponse: 0, explication: 'mientras décrit une action EN COURS : imperfecto. L’action qui vient l’interrompre, sonó, reste à l’indefinido. Cette phrase contient toute la règle du chapitre.' },
      { type: 'vraifaux', question: '« Viví diez años en Madrid » devrait être à l’imperfecto, car dix ans c’est long.', reponse: false, explication: 'Faux. La DURÉE ne décide jamais : ce qui compte est que la période soit close et bornée. Dix ans achevés forment un bloc fermé, donc l’indefinido.' },
      { type: 'qcm', question: 'Quel marqueur appelle l’imperfecto ?', choix: ['todos los días', 'ayer', 'anoche', 'en 2019'], reponse: 0, explication: 'Les marqueurs de l’imperfecto désignent une répétition ou une durée sans limite précise : antes, siempre, a menudo, cada verano, mientras.' },
      { type: 'qcm', question: 'Quel marqueur appelle l’indefinido ?', choix: ['de repente', 'siempre', 'a menudo', 'normalmente'], reponse: 0, explication: 'de repente introduit une action ponctuelle qui fait avancer le récit. Comme ayer, anoche, un día ou el año pasado, il désigne un moment précis et clos.' },
      { type: 'qcm', question: 'Complète : Hoy ……… en casa.', choix: ['he comido', 'comí', 'comía', 'como'], reponse: 0, explication: 'hoy désigne une période NON TERMINÉE : c’est le pretérito perfecto. Ayer comí serait l’indefinido, antes comía l’imperfecto.' },
      { type: 'qcm', question: 'Quelles sont les deux questions pour choisir parmi les trois passés ?', choix: ['la période est-elle finie, est-ce une action ou un cadre', 'le verbe est-il régulier, est-il long', 'y a-t-il un accent, y a-t-il un marqueur', 'le sujet est-il au pluriel, le verbe est-il irrégulier'], reponse: 0, explication: 'Si la période n’est pas finie, c’est le pretérito perfecto et on s’arrête. Si elle est finie : action → indefinido, cadre → imperfecto.' },
      { type: 'qcm', question: 'Lequel de ces emplois relève de l’imperfecto ?', choix: ['la description d’un lieu', 'une succession de trois actions', 'une action unique datée', 'un fait qui fait avancer le récit'], reponse: 0, explication: 'L’imperfecto a quatre emplois : description, habitude, action en cours, état physique ou mental. Les trois autres propositions relèvent de l’indefinido.' },
      { type: 'qcm', question: 'Si l’on dirait « je faisais » en français, quel temps espagnol emploie-t-on ?', choix: ['l’imperfecto', 'l’indefinido', 'le pretérito perfecto', 'le présent'], reponse: 0, explication: 'Le français fait exactement la même distinction : imparfait français → imperfecto, passé composé ou simple → indefinido. Cette correspondance fonctionne dans plus de neuf cas sur dix.' },
      { type: 'saisie', question: 'Comment dit-on « le souvenir » en espagnol ? (deux mots)', reponses: ['el recuerdo', 'recuerdo'], explication: 'el recuerdo, du verbe recordar. Attention à la construction : Recuerdo aquel verano, sans préposition, mais Me acuerdo DE aquel verano avec acordarse.' },
      { type: 'vraifaux', question: 'Un récit entièrement à l’indefinido est aussi bon qu’un récit qui alterne les deux temps.', reponse: false, explication: 'Faux. Un texte tout à l’indefinido devient une liste d’actions sans atmosphère ; un texte tout à l’imperfecto ne progresse jamais. C’est leur alternance qui crée un récit.' }
    ]
  }
,
  'maths/L10': {
    ...
    items: [
      { type: 'qcm', question: 'Combien de faces a une pyramide à base carrée ?', choix: ['5', '4', '6', '8'], reponse: 0, explication: 'La base plus quatre triangles. Règle générale pour une base à n côtés : n + 1 faces, n + 1 sommets, 2n arêtes. Ici : 5 faces, 5 sommets, 8 arêtes.' },
      { type: 'qcm', question: 'Qu’est-ce que la hauteur d’une pyramide ?', choix: ['le segment perpendiculaire à la base joignant le sommet', 'l’arête latérale', 'la hauteur d’une face', 'le côté de la base'], reponse: 0, explication: 'Elle est intérieure au solide et toujours PLUS COURTE que l’arête latérale. Employer l’arête dans la formule du volume donne un résultat trop grand.' },
      { type: 'saisie', question: 'Quelle est la formule du volume d’une pyramide ? (sous la forme V = ...)', reponses: ['v = aire de la base x hauteur / 3', 'v = aire x hauteur / 3', 'v = b x h / 3', 'v = aire de la base × hauteur ÷ 3'], explication: 'V = aire de la base × hauteur ÷ 3. Pour un cône, c’est la même formule : V = π × r² × h ÷ 3, puisque l’aire de la base vaut πr².' },
      { type: 'saisie', question: 'Une pyramide a une base carrée de 6 cm de côté et 10 cm de hauteur. Quel est son volume ? (en cm³, chiffre seul)', reponses: ['120'], explication: 'Aire de la base : 6 × 6 = 36 cm². Volume : 36 × 10 ÷ 3 = 120 cm³. Ne jamais oublier la division par 3, sous peine de tripler le résultat.' },
      { type: 'qcm', question: 'Une pyramide et un prisme ont même base et même hauteur. Quel rapport entre leurs volumes ?', choix: ['la pyramide vaut un tiers du prisme', 'ils sont égaux', 'la pyramide vaut la moitié', 'la pyramide vaut le quart'], reponse: 0, explication: 'Il faut exactement trois pyramides pleines de sable pour remplir le prisme. La même règle vaut pour le cône et le cylindre : les solides à pointe valent un tiers du solide droit correspondant.' },
      { type: 'qcm', question: 'Combien de cm³ vaut 1 m³ ?', choix: ['1 000 000', '100', '1 000', '10 000'], reponse: 0, explication: '1 m = 100 cm, donc 1 m³ = 100 × 100 × 100 = 1 000 000 cm³. Chaque changement d’unité multiplie le volume par 1 000, parce qu’un volume est un produit de TROIS longueurs.' },
      { type: 'saisie', question: 'Combien de litres vaut 1 dm³ ? (chiffre seul)', reponses: ['1', 'un'], explication: '1 dm³ = 1 L, et 1 cm³ = 1 mL. Ce sont les deux équivalences à connaître par cœur : elles permettent de passer d’un volume géométrique à une contenance.' },
      { type: 'qcm', question: 'Quelle relation lie la génératrice g, la hauteur h et le rayon r d’un cône ?', choix: ['g² = h² + r²', 'g = h + r', 'h² = g² + r²', 'g² = h² − r²'], reponse: 0, explication: 'Les trois longueurs forment un triangle rectangle dont la génératrice est l’hypoténuse. C’est le théorème de Pythagore appliqué dans le solide.' },
      { type: 'saisie', question: 'Un cône a un rayon de 6 cm et une génératrice de 10 cm. Quelle est sa hauteur ? (en cm, chiffre seul)', reponses: ['8'], explication: 'h² = g² − r² = 100 − 36 = 64, donc h = 8 cm. Le triplet 6-8-10 est un triplet pythagoricien classique : le reconnaître fait gagner du temps.' },
      { type: 'qcm', question: 'De quoi est composé le patron d’un cône ?', choix: ['un disque et un secteur de disque', 'deux disques', 'un disque et un triangle', 'un disque et un rectangle'], reponse: 0, explication: 'Le disque est la base, de rayon r ; le secteur est la surface latérale dépliée, de rayon g. L’angle du secteur vaut 360 × r ÷ g.' },
      { type: 'saisie', question: 'Un cône a r = 3 cm et g = 9 cm. Quel est l’angle du secteur de son patron ? (en degrés, chiffre seul)', reponses: ['120'], explication: 'angle = 360 × r ÷ g = 360 × 3 ÷ 9 = 120°. Vérification : l’arc du secteur, 6π, égale bien la circonférence de la base, 2π × 3 = 6π.' },
      { type: 'vraifaux', question: 'Dans une perspective cavalière, on peut mesurer les longueurs sur le dessin.', reponse: false, explication: 'Faux. Les longueurs y sont déformées : un carré apparaît comme un parallélogramme, un cercle comme une ellipse. On n’emploie que les données de l’énoncé ou du codage.' },
      { type: 'qcm', question: 'On coupe un cône à mi-hauteur, parallèlement à la base. Quel volume représente le petit cône ?', choix: ['le huitième', 'la moitié', 'le quart', 'le tiers'], reponse: 0, explication: 'k = 0,5 pour les longueurs, k² = 0,25 pour les aires, k³ = 0,125 pour les volumes. Couper à mi-hauteur laisse donc SEPT HUITIÈMES du volume en bas.' },
      { type: 'qcm', question: 'Dans une section parallèle à la base de coefficient k, par combien les aires sont-elles multipliées ?', choix: ['k²', 'k', 'k³', '2k'], reponse: 0, explication: 'Les longueurs par k, les aires par k², les volumes par k³. Une aire est un produit de deux longueurs, un volume de trois : les exposants suivent.' },
      { type: 'qcm', question: 'Dans une pyramide régulière, avec quelle longueur emploie-t-on l’ARÊTE LATÉRALE pour Pythagore ?', choix: ['la demi-diagonale de la base', 'le demi-côté de la base', 'le côté entier', 'la diagonale entière'], reponse: 0, explication: 'L’arête relie le sommet à un COIN de la base : la distance du centre au coin est la demi-diagonale. Avec l’apothème, qui vise le milieu d’un côté, on emploie le demi-côté.' },
      { type: 'saisie', question: 'Une pyramide a une base carrée de 5 cm de côté et un volume de 75 cm³. Quelle est sa hauteur ? (en cm, chiffre seul)', reponses: ['9'], explication: 'h = 3 × V ÷ aire = 3 × 75 ÷ 25 = 9 cm. Pour isoler une grandeur : multiplier d’abord par 3, puis diviser par ce qui accompagne la grandeur cherchée.' },
      { type: 'qcm', question: 'Un cône a un DIAMÈTRE de 10 cm et une hauteur de 12 cm. Quel est son volume ?', choix: ['100π cm³', '400π cm³', '120π cm³', '300π cm³'], reponse: 0, explication: 'Il faut d’abord diviser le diamètre par 2 : r = 5 cm. Puis V = π × 25 × 12 ÷ 3 = 100π cm³. Employer 10 comme rayon quadruplerait le résultat.' },
      { type: 'qcm', question: 'Comment obtient-on un cône de révolution ?', choix: ['en faisant tourner un triangle rectangle autour d’un côté de l’angle droit', 'en empilant des disques', 'en pliant un rectangle', 'en faisant tourner un carré'], reponse: 0, explication: 'Le côté autour duquel on tourne devient la hauteur, l’autre côté de l’angle droit devient le rayon, et l’hypoténuse devient la génératrice.' },
      { type: 'vraifaux', question: 'L’arête latérale d’une pyramide est plus courte que sa hauteur.', reponse: false, explication: 'Faux, elle est toujours PLUS LONGUE. La hauteur est le plus court chemin du sommet à la base, puisqu’elle est perpendiculaire ; toute autre ligne vers la base est oblique, donc plus longue.' },
      { type: 'qcm', question: 'Un tas de sable conique fait 4 m de diamètre et 1,5 m de hauteur. Quel est son volume ?', choix: ['environ 6,28 m³', 'environ 25,1 m³', 'environ 18,8 m³', 'environ 2,1 m³'], reponse: 0, explication: 'Rayon : 2 m. V = π × 4 × 1,5 ÷ 3 = 2π ≈ 6,28 m³, soit 6 280 litres. Contrôle de vraisemblance : un tel tas tiendrait dans une petite pièce, c’est plausible.' }
    ]
  }
,
  'maths/L11': {
    ...
    items: [
      ...
      { type: 'qcm', question: 'Lequel de ces points est TOUJOURS à l’intérieur du triangle ?', choix: ['le centre de gravité', 'l’orthocentre', 'le centre du cercle circonscrit', 'aucun'], reponse: 0, explication: 'G et I sont toujours intérieurs. O et H peuvent sortir du triangle quand celui-ci a un angle obtus. Cette distinction permet de repérer une erreur de construction.' },
      { type: 'qcm', question: 'Où se trouve le centre du cercle circonscrit d’un triangle RECTANGLE ?', choix: ['au milieu de l’hypoténuse', 'au sommet de l’angle droit', 'au centre de gravité', 'à l’extérieur'], reponse: 0, explication: 'Le rayon vaut donc la moitié de l’hypoténuse, et l’hypoténuse est un diamètre du cercle. Cette propriété sera réutilisée en 3e.' },
      { type: 'qcm', question: 'Où se trouve l’orthocentre d’un triangle rectangle ?', choix: ['au sommet de l’angle droit', 'au milieu de l’hypoténuse', 'au centre du triangle', 'à l’extérieur'], reponse: 0, explication: 'Les deux côtés de l’angle droit sont perpendiculaires entre eux : chacun porte donc la hauteur issue de l’autre sommet, et les trois hauteurs se coupent au sommet de l’angle droit.' },
      { type: 'saisie', question: 'Une médiane [AA’] mesure 9 cm. Combien mesure AG ? (en cm, chiffre seul)', reponses: ['6'], explication: 'AG = (2/3) × 9 = 6 cm, et GA’ = 3 cm. Le centre de gravité est aux deux tiers EN PARTANT DU SOMMET, et AG vaut toujours le double de GA’.' },
      { type: 'qcm', question: 'Si GA’ = 5 cm, combien mesure AG ?', choix: ['10 cm', '2,5 cm', '5 cm', '15 cm'], reponse: 0, explication: 'AG = 2 × GA’ = 10 cm, et la médiane entière mesure 15 cm. Ce rapport double est plus commode à manipuler que les fractions.' },
      { type: 'vraifaux', question: 'Dans un triangle obtusangle, toutes les hauteurs tombent à l’intérieur du triangle.', reponse: false, explication: 'Faux : deux des trois hauteurs tombent à l’EXTÉRIEUR, et il faut prolonger le côté opposé pour placer leur pied. C’est la difficulté de construction la plus fréquente du chapitre.' },
      { type: 'qcm', question: 'Le centre du cercle inscrit est équidistant :', choix: ['des trois côtés', 'des trois sommets', 'des trois médianes', 'des trois hauteurs'], reponse: 0, explication: 'D’où un cercle TANGENT aux trois côtés. Le centre du cercle circonscrit, lui, est équidistant des trois SOMMETS, d’où un cercle qui les traverse.' },
      { type: 'qcm', question: 'Comment obtient-on le rayon du cercle inscrit ?', choix: ['en traçant la perpendiculaire de I à un côté', 'en ouvrant le compas jusqu’à toucher un côté', 'en mesurant IA', 'en divisant un côté par deux'], reponse: 0, explication: 'Le rayon se CONSTRUIT, il ne se prend jamais au jugé. Ouvrir le compas approximativement donne un cercle qui coupe un côté et en manque un autre.' },
      { type: 'vraifaux', question: 'Dans un triangle isocèle en A, la hauteur, la médiane, la médiatrice et la bissectrice issues de A sont confondues.', reponse: true, explication: 'Vrai : c’est l’axe de symétrie du triangle. Attention, cette coïncidence ne vaut QUE pour le sommet principal : en B et en C, les quatre droites restent distinctes.' },
      { type: 'qcm', question: 'Dans un triangle équilatéral, que peut-on dire des quatre points de concours ?', choix: ['ils sont confondus en un seul point', 'ils forment un carré', 'ils sont alignés', 'ils sont tous à l’extérieur'], reponse: 0, explication: 'O = H = G = I. Le triangle est isocèle par rapport à chacun de ses trois sommets : les quatre familles sont donc constituées des mêmes trois droites.' },
      { type: 'qcm', question: 'Dans un triangle, la médiane et la hauteur issues de A sont confondues. Que peut-on en déduire ?', choix: ['le triangle est isocèle en A', 'le triangle est rectangle', 'le triangle est équilatéral', 'on ne peut rien en déduire'], reponse: 0, explication: 'Cette droite est alors la médiatrice de [BC], puisqu’elle est perpendiculaire à [BC] et passe par son milieu. Donc A est à égale distance de B et C : AB = AC.' },
      { type: 'qcm', question: 'Pourquoi deux droites d’une même famille suffisent-elles à trouver le point de concours ?', choix: ['parce que les trois sont concourantes', 'parce que la troisième est parallèle', 'parce qu’elles sont perpendiculaires', 'parce que le triangle a trois côtés'], reponse: 0, explication: 'Deux droites sécantes se coupent en un point unique, qui appartient nécessairement à la troisième. Celle-ci ne sert donc que de vérification, mais elle est utile à ce titre.' },
      { type: 'vraifaux', question: 'Une médiane partage le triangle en deux triangles de même aire.', reponse: true, explication: 'Vrai. Les deux triangles obtenus ont des bases de même longueur, les deux moitiés du côté, et la même hauteur, celle issue du sommet. Leurs aires sont donc égales.' },
      { type: 'qcm', question: 'Un point M vérifie MA = MB. Que peut-on en déduire ?', choix: ['M appartient à la médiatrice de [AB]', 'M est le milieu de [AB]', 'M appartient à la bissectrice', 'M est le centre de gravité'], reponse: 0, explication: 'C’est la propriété caractéristique appliquée dans le sens de la réciproque. Un point est à égale distance des extrémités d’un segment SI ET SEULEMENT SI il est sur sa médiatrice.' }
    ]
  }
,
  'maths/L12': {
    ...
    items: [
      { type: 'qcm', question: 'Que signifie l’instruction x ← 5 ?', choix: ['x prend la valeur 5', 'x est égal à 5', 'x est plus petit que 5', 'on vérifie si x vaut 5'], reponse: 0, explication: 'C’est une AFFECTATION : un ordre donné à la machine, qui écrase l’ancienne valeur. En mathématiques, x = 5 est une affirmation qui ne modifie rien.' },
      ...
      { type: 'saisie', question: 'Après x ← 3, y ← 7, x ← x + y, que vaut x ? (chiffre seul)', reponses: ['10'], explication: 'On calcule 3 + 7 = 10, puis on range dans x. La variable y reste à 7 : elle n’a pas été modifiée.' },
      { type: 'qcm', question: 'Quelles sont les trois structures de base de la programmation ?', choix: ['la séquence, le test, la boucle', 'la variable, le calcul, l’affichage', 'l’entrée, le traitement, la sortie', 'le si, le sinon, le pour'], reponse: 0, explication: 'Aucun programme, si complexe soit-il, n’emploie autre chose. Tout le reste n’est qu’une combinaison de ces trois structures.' },
      { type: 'qcm', question: 'Après a ← 3, b ← a, a ← 10, que vaut b ?', choix: ['3', '10', '13', 'rien'], reponse: 0, explication: 'L’affectation b ← a a copié la VALEUR de a à ce moment-là, soit 3. Modifier a ensuite ne change pas b : les deux variables restent indépendantes.' },
      { type: 'qcm', question: 'Pourquoi a ← b puis b ← a n’échange-t-il pas deux valeurs ?', choix: ['la première affectation détruit l’ancienne valeur de a', 'l’ordre des instructions est inversé', 'il manque une boucle', 'il faut un test'], reponse: 0, explication: 'Avec a = 3 et b = 7 : après a ← b, les deux valent 7 et 3 est perdu. Il faut une variable temporaire : t ← a, a ← b, b ← t.' },
      { type: 'qcm', question: 'Pour n = 10, la condition n > 10 est :', choix: ['fausse', 'vraie', 'indéterminée', 'impossible à évaluer'], reponse: 0, explication: 'L’opérateur > est STRICT : il exclut la valeur. Avec ≥, la condition serait vraie. Un seul caractère change le comportement du programme, sans aucun message d’erreur.' },
      { type: 'qcm', question: 'Pour n = 7, que vaut la condition n > 0 ET n < 5 ?', choix: ['fausse', 'vraie', 'les deux', 'indéterminée'], reponse: 0, explication: '7 > 0 est vrai mais 7 < 5 est faux. Avec ET, les DEUX conditions doivent être vraies. Avec OU, une seule suffirait.' },
      { type: 'qcm', question: 'Quelle est la différence entre une boucle bornée et une boucle non bornée ?', choix: ['le nombre de répétitions est connu à l’avance ou non', 'l’une est plus rapide', 'l’une ne fonctionne qu’avec des nombres', 'il n’y a aucune différence'], reponse: 0, explication: 'Pour i allant de 1 à n répète un nombre connu de fois. Tant que condition répète tant qu’une condition est vraie, avec un risque de boucle infinie.' },
      { type: 'saisie', question: 'Que vaut s à la fin ? s ← 0 ; Pour i de 1 à 5 : s ← s + i (chiffre seul)', reponses: ['15'], explication: 's prend les valeurs 0, 1, 3, 6, 10, 15. Le programme calcule 1 + 2 + 3 + 4 + 5. Sans la ligne s ← 0, rien ne fonctionnerait.' },
      { type: 'vraifaux', question: 'Une variable accumulatrice doit être initialisée avant la boucle.', reponse: true, explication: 'Vrai, c’est l’oubli le plus fréquent en programmation. Pour une somme on initialise à 0 ; pour un produit, à 1, sinon tous les produits vaudraient 0.' },
      { type: 'qcm', question: 'Pourquoi cette boucle ne s’arrête-t-elle jamais : n ← 1 ; Tant que n ≤ 100 : Afficher n ?', choix: ['rien ne modifie n', 'la condition est mal écrite', 'il manque un test', 'Afficher ne fonctionne pas'], reponse: 0, explication: 'C’est une BOUCLE INFINIE. Toute boucle Tant que doit contenir une instruction qui fait progresser vers la condition d’arrêt, ici n ← n + 1.' },
      { type: 'saisie', question: 'n ← 1 ; Tant que n ≤ 100 : n ← n × 2. Que vaut n à la fin ? (chiffre seul)', reponses: ['128'], explication: 'n prend les valeurs 1, 2, 4, 8, 16, 32, 64, 128. La boucle s’arrête car 128 ≤ 100 est faux. Elle a tourné sept fois.' },
      { type: 'qcm', question: 'Que calcule ce programme : p ← 1 ; Pour i de 1 à 4 : p ← p × 2 ?', choix: ['2 puissance 4, soit 16', '2 × 4, soit 8', '4 puissance 2, soit 16', '1 + 2 + 3 + 4'], reponse: 0, explication: 'p prend les valeurs 1, 2, 4, 8, 16. L’initialisation à 1 est essentielle : avec p ← 0, tous les produits vaudraient 0.' },
      { type: 'qcm', question: 'Si Afficher se trouve À L’INTÉRIEUR d’une boucle de 10 tours :', choix: ['le programme affiche dix valeurs', 'le programme affiche une valeur', 'le programme plante', 'cela ne change rien'], reponse: 0, explication: 'Ce qui se fait une seule fois, initialisation et affichage final, reste HORS de la boucle. Ce qui doit être répété va à l’intérieur.' },
      { type: 'qcm', question: 'Quelle est la méthode fiable pour comprendre un programme inconnu ?', choix: ['le dérouler pas à pas dans un tableau', 'le lire attentivement', 'demander à l’auteur', 'l’exécuter et regarder le résultat'], reponse: 0, explication: 'Une colonne par variable, une ligne par instruction exécutée. Deviner en lisant conduit presque toujours à une erreur d’un tour de boucle.' },
      { type: 'saisie', question: 'De combien de degrés un lutin doit-il tourner pour tracer un pentagone régulier ? (chiffre seul)', reponses: ['72'], explication: 'angle = 360 ÷ n = 360 ÷ 5 = 72°. Attention, c’est l’angle EXTÉRIEUR : l’angle intérieur d’un pentagone régulier vaut 108°.' },
      { type: 'qcm', question: 'Pour un triangle équilatéral, de combien le lutin tourne-t-il ?', choix: ['120 degrés', '60 degrés', '90 degrés', '180 degrés'], reponse: 0, explication: 'Il pivote de l’angle EXTÉRIEUR, soit 360 ÷ 3 = 120°, alors que les angles du triangle mesurent 60°. Les deux sont supplémentaires : 60 + 120 = 180.' },
      { type: 'qcm', question: 'Qu’est-ce qu’un programme paramétré ?', choix: ['un programme qui traite tous les cas à partir de valeurs saisies', 'un programme très long', 'un programme sans boucle', 'un programme écrit pour un seul exemple'], reponse: 0, explication: 'Un programme qui trace n’importe quel polygone régulier vaut bien mieux que cinq programmes écrits chacun pour un polygone. Généraliser plutôt que répéter est l’un des principaux intérêts de la programmation.' },
      { type: 'vraifaux', question: 'Une machine devine l’intention du programmeur quand une instruction est ambiguë.', reponse: false, explication: 'Faux. Une machine n’interprète pas, elle exécute. Si l’instruction est ambiguë, elle produira un résultat inattendu sans signaler d’erreur : c’est la difficulté principale de la programmation, et elle est plus logique que technique.' }
    ]
  }
,
  'francais/L05': {
    ...
    items: [
      { type: 'qcm', question: 'Qu’est-ce qu’un fait ?', choix: ['un énoncé vérifiable', 'un énoncé vrai', 'un jugement personnel', 'une explication'], reponse: 0, explication: 'Un fait est VÉRIFIABLE, pas nécessairement vrai : « la Terre est plate » est un fait au sens grammatical, et il est faux. Une opinion, elle, ne peut être ni prouvée ni réfutée.' },
      { type: 'qcm', question: '« Ce film est trop long » est :', choix: ['une opinion', 'un fait', 'une interprétation', 'une source'], reponse: 0, explication: '« Trop long » est un jugement. En revanche, « ce film dure 118 minutes » est un fait : la même durée donne lieu à un fait ou à une opinion selon la façon de l’énoncer.' },
      { type: 'qcm', question: '« Cette hausse s’explique par le changement climatique » est :', choix: ['une interprétation', 'un fait', 'une opinion', 'une rumeur'], reponse: 0, explication: 'Une interprétation propose une EXPLICATION d’un fait : elle s’appuie sur des faits mais va au-delà, et demande à être étayée.' },
      { type: 'qcm', question: 'Que demande-t-on devant un FAIT ? Et devant une OPINION ?', choix: ['une source pour le fait, des arguments pour l’opinion', 'des arguments pour le fait, une source pour l’opinion', 'une source pour les deux', 'rien dans les deux cas'], reponse: 0, explication: 'Confondre les deux rend toute discussion impossible : on exige des preuves pour un goût, ou on accepte sans preuve ce qui devrait en avoir.' },
      { type: 'vraifaux', question: '« Selon une étude » est une source valable.', reponse: false, explication: 'Faux. Une source réelle est IDENTIFIABLE, datable et retrouvable. « Selon des experts » ou « un proche du dossier » ont l’apparence d’une source sans en être une.' },
      { type: 'qcm', question: 'Quelles sont les quatre questions à poser sur une source ?', choix: ['qui, quand, pourquoi, comment le sait-il', 'qui, où, combien, pourquoi', 'quoi, qui, quand, où', 'est-ce vrai, est-ce utile, est-ce récent, est-ce long'], reponse: 0, explication: 'La question « pourquoi » n’accuse personne : elle demande simplement qui a intérêt à ce que l’on croie cela. Un fabricant publiant une étude sur son produit n’est pas malhonnête, mais il n’est pas neutre.' },
      { type: 'qcm', question: 'Qu’est-ce qu’une source primaire ?', choix: ['le document d’origine : rapport, témoignage direct, mesure', 'le premier article publié sur le sujet', 'la source la plus connue', 'le site le plus consulté'], reponse: 0, explication: 'Beaucoup d’informations fausses circulent parce que personne ne remonte au document d’origine : un article cite un article qui cite un billet qui cite une phrase sortie de son contexte.' },
      { type: 'qcm', question: 'Qui écrit le titre d’un article de presse ?', choix: ['un service dont la mission est d’attirer l’attention', 'l’auteur de l’article', 'la personne interviewée', 'un logiciel'], reponse: 0, explication: 'Le titre doit être court, compris en une seconde et donner envie de cliquer. Ces trois exigences ne coïncident pas nécessairement avec l’exactitude.' },
      { type: 'qcm', question: '« Faut-il s’inquiéter de cette nouvelle application ? » : quel procédé ?', choix: ['la question rhétorique', 'le conditionnel', 'le superlatif', 'l’amalgame'], reponse: 0, explication: 'Elle installe l’idée qu’il y aurait lieu de s’inquiéter, sans rien affirmer. Même si l’article répond « non », le titre aura transmis l’inquiétude à ceux qui ne l’ont pas lu.' },
      { type: 'qcm', question: '« Le maire aurait démissionné » : que signale le conditionnel ?', choix: ['l’information est incertaine, ou invérifiée', 'l’information est certaine', 'le maire a démissionné', 'le maire va démissionner'], reponse: 0, explication: 'Le lecteur ne peut pas distinguer une incertitude honnête d’une information publiée sans en répondre. La seule réaction utile est de chercher QUI l’affirme.' },
      { type: 'qcm', question: 'Quel est le procédé de désinformation le plus répandu avec les images ?', choix: ['une photographie authentique mal légendée', 'un montage élaboré', 'une image générée par ordinateur', 'une image floue'], reponse: 0, explication: 'Il ne demande AUCUNE compétence technique : on prend une image vraie et on change sa date, son lieu ou son événement. Une recherche d’image inversée permet souvent de le détecter.' },
      { type: 'qcm', question: 'Deux photographies de la même manifestation, l’une dense et l’autre clairsemée : que conclure ?', choix: ['le cadrage change ce qu’on voit sans truquer', 'l’une des deux est truquée', 'la manifestation a changé de taille', 'les deux sont fausses'], reponse: 0, explication: 'Prise du premier rang, une file paraît dense ; prise d’un toit, elle paraît clairsemée. Aucune n’est truquée, et pourtant elles ne racontent pas la même chose.' },
      { type: 'qcm', question: '« 3 000 cas recensés » : quelle information manque ?', choix: ['sur quelle population, quelle durée, comparé à quoi', 'le nom du responsable', 'la couleur du graphique', 'rien, l’information est complète'], reponse: 0, explication: '3 000 cas sur 60 millions d’habitants en un an, ou sur mille personnes en une semaine, ne décrivent pas du tout la même situation. Un chiffre isolé paraît précis sans l’être.' },
      { type: 'qcm', question: 'Quelles sont les trois conditions de naissance d’une rumeur ?', choix: ['un sujet important, une incertitude, un manque de confiance', 'un mensonge, un menteur, un public', 'internet, la vitesse, l’anonymat', 'la peur, la colère, la tristesse'], reponse: 0, explication: 'Sans ces trois éléments réunis, une rumeur ne prend pas. Le meilleur moyen de l’éviter n’est donc pas de la démentir après coup, mais de combler l’incertitude à temps.' },
      { type: 'vraifaux', question: 'Celui qui relaie une rumeur ment.', reponse: false, explication: 'Faux. Il croit le plus souvent ce qu’il dit : il n’y a pas d’intention de tromper. C’est ce qui rend une rumeur difficile à arrêter, et pourquoi elle se combat par l’information vérifiée, jamais par l’accusation.' },
      { type: 'qcm', question: '« Soit on interdit complètement, soit on laisse tout faire » : quel procédé ?', choix: ['le faux dilemme', 'l’amalgame', 'la généralisation abusive', 'l’attaque de la personne'], reponse: 0, explication: 'La phrase supprime toutes les positions intermédiaires, qui sont pourtant les plus nombreuses. Repérer un faux dilemme consiste simplement à chercher une troisième option.' },
      { type: 'qcm', question: '« Mon voisin a eu un problème avec cette marque, elle est nulle » : quel procédé ?', choix: ['la généralisation abusive', 'le faux dilemme', 'l’appel à l’émotion', 'la citation tronquée'], reponse: 0, explication: 'Un cas unique ne permet aucune conclusion sur l’ensemble d’une production. Il faudrait connaître la proportion de produits défectueux, pas un exemple.' },
      { type: 'vraifaux', question: 'Vingt sites qui disent la même chose constituent vingt sources.', reponse: false, explication: 'Faux. S’ils reprennent le même article, ils ne font qu’UNE seule source recopiée vingt fois. Croiser suppose des sources indépendantes, qui ont chacune vérifié de leur côté : croiser n’est pas compter.' },
      { type: 'qcm', question: 'Quelles sont les cinq étapes de la vérification ?', choix: ['nature, source, origine, croisement, date', 'lire, partager, vérifier, corriger, oublier', 'douter, chercher, croire, partager, attendre', 'titre, image, texte, auteur, date'], reponse: 0, explication: 'Identifier la nature de l’énoncé, chercher la source, remonter au document primaire, croiser avec des sources indépendantes, et dater l’information.' },
      { type: 'qcm', question: 'Quel élément d’un message doit éveiller la méfiance immédiatement ?', choix: ['« fais suivre à tous tes contacts »', 'une date précise', 'un lien vers un site officiel', 'le nom de l’auteur'], reponse: 0, explication: 'Une demande explicite de partage massif est l’un des indices les plus fiables de désinformation : elle vise à faire circuler l’information avant qu’elle ne soit vérifiée. Une information exacte n’a pas besoin de cette consigne.' }
    ]
  }
,
  'francais/L10': {
    ...
    items: [
      { type: 'qcm', question: 'Quels sont les quatre repérages d’une consigne ?', choix: ['le verbe, la forme, les contraintes, le destinataire', 'le sujet, le verbe, le complément, la ponctuation', 'le titre, le plan, les exemples, la conclusion', 'la longueur, le temps, le lieu, le style'], reponse: 0, explication: 'Deux minutes de lecture attentive évitent un hors-sujet que trente minutes de rédaction ne rattrapent pas. C’est le meilleur rapport entre temps investi et points gagnés.' },
      { type: 'vraifaux', question: '« Raconte une rencontre et explique ce qu’elle a changé » ne demande qu’une seule chose.', reponse: false, explication: 'Faux, la consigne est DOUBLE : un récit et une explication. Un texte qui n’en traite qu’une est incomplet, même s’il est bien écrit. Surligne chaque demande séparément.' },
      { type: 'qcm', question: 'Dans les cinq minutes de brouillon, que fait-on en deux minutes ?', choix: ['noter toutes les idées en vrac, sans trier', 'rédiger l’introduction', 'choisir le meilleur exemple', 'relire la consigne'], reponse: 0, explication: 'Chercher la bonne idée et l’ordonner en même temps bloque presque toujours. Séparer produire et trier débloque l’écriture : une idée notée puis barrée en a fait venir une autre.' },
      { type: 'qcm', question: 'Combien d’idées un paragraphe développe-t-il ?', choix: ['une seule', 'deux ou trois', 'autant que nécessaire', 'cela n’a pas d’importance'], reponse: 0, explication: 'Une idée, un paragraphe. Le découpage est la première chose que voit un lecteur, avant même de lire : un texte en quatre blocs équilibrés annonce un plan, un texte d’un seul bloc annonce son absence.' },
      { type: 'saisie', question: 'Quelle étape du schéma narratif rompt l’équilibre initial ? (deux mots)', reponses: ['élément perturbateur', 'l’élément perturbateur', 'element perturbateur'], explication: 'Sans lui, une succession d’actions n’est pas un récit mais une liste : le lecteur ne voit pas pourquoi on lui raconte cela.' },
      { type: 'qcm', question: 'Dans un récit au passé, quel temps emploie-t-on pour le décor ?', choix: ['l’imparfait', 'le passé simple', 'le présent', 'le futur'], reponse: 0, explication: 'Imparfait pour le décor, les descriptions et les habitudes ; passé simple ou composé pour les actions. On ne mélange JAMAIS ce système avec le présent de narration.' },
      { type: 'vraifaux', question: 'On peut alterner passé simple et présent de narration dans un même récit.', reponse: false, explication: 'Faux. On choisit un système, passé ou présent, et on s’y tient du début à la fin. Le mélange est l’une des erreurs les plus visibles dans un devoir.' },
      { type: 'qcm', question: 'Quelle règle lie la formule d’appel et la formule de politesse ?', choix: ['la politesse reprend exactement la formule d’appel', 'elles doivent être différentes', 'la politesse est toujours « Madame, Monsieur »', 'il n’y a aucun lien'], reponse: 0, explication: 'Si l’on a écrit « Madame la Directrice, » en tête, la formule finale doit contenir « Madame la Directrice ». C’est une règle mécanique, facile à respecter et souvent oubliée.' },
      { type: 'qcm', question: 'Quelles sont les trois marques à traquer en priorité dans un écrit formel ?', choix: ['le ne oublié, le on pour nous, les abréviations', 'les majuscules, les virgules, les accents', 'les adjectifs, les adverbes, les pronoms', 'les titres, les dates, les signatures'], reponse: 0, explication: 'Trois erreurs suffisent à faire basculer un texte du soutenu au familier, et à lui faire perdre toute crédibilité, même si le fond est excellent.' },
      { type: 'qcm', question: 'Quelles sont les cinq questions auxquelles un article doit répondre ?', choix: ['qui, quoi, quand, où, pourquoi', 'qui, comment, combien, où, quand', 'quoi, où, quand, combien, comment', 'qui, quoi, comment, combien, pourquoi'], reponse: 0, explication: 'On y ajoute souvent une sixième, « comment ». Un article qui laisse l’une des cinq sans réponse est incomplet.' },
      { type: 'qcm', question: 'Qu’est-ce que la pyramide inversée ?', choix: ['l’information la plus importante en premier', 'la révélation à la fin', 'un plan en trois parties', 'un titre plus long que l’article'], reponse: 0, explication: 'Ainsi un lecteur qui s’arrête après trois lignes a déjà l’essentiel. C’est l’inverse d’un récit, où la révélation vient à la fin.' },
      { type: 'vraifaux', question: 'Dans un article d’information, le journaliste donne son avis.', reponse: false, explication: 'Faux. Les jugements se marquent par les adjectifs évaluatifs et les adverbes : les supprimer est la première correction à faire. Pour donner un avis, c’est un ÉDITORIAL, et il se signale comme tel.' },
      { type: 'qcm', question: '« La lecture enrichit le vocabulaire » est :', choix: ['un argument', 'un exemple', 'une thèse', 'une objection'], reponse: 0, explication: 'Un argument répond à « pourquoi ? », un exemple à « comme quoi ? ». « J’ai lu trois romans cet été » serait un exemple, et assez faible : un cas individuel n’établit rien.' },
      { type: 'vraifaux', question: '« Le sport est bon pour la santé, par exemple le football » est un argument.', reponse: false, explication: 'Faux. Le football est un EXEMPLE de sport, pas une raison. Un paragraphe qui n’aligne que des exemples n’argumente pas : il faut répondre à la question « pourquoi ? ».' },
      { type: 'qcm', question: 'Quelle structure permet de traiter une objection ?', choix: ['Certes ..., mais ...', 'De plus ..., ensuite ...', 'D’abord ..., enfin ...', 'Par exemple ..., ainsi ...'], reponse: 0, explication: 'Certes reconnaît ce que l’adversaire a de juste, mais introduit la réponse. Employer certes SANS mais laisse le lecteur sur l’argument adverse, ce qui est l’inverse du but recherché.' },
      { type: 'vraifaux', question: 'Ignorer l’argument adverse rend un texte argumenté plus solide.', reponse: false, explication: 'Faux, cela l’affaiblit : le lecteur y pense pendant qu’il lit. Reconnaître l’objection puis y répondre montre qu’on a examiné la question, et c’est la marque d’un devoir de bon niveau.' },
      { type: 'qcm', question: 'Combien de passages compte la grille de relecture ?', choix: ['six', 'deux', 'trois', 'dix'], reponse: 0, explication: 'Consigne, plan, accords, temps, registre, ponctuation. Six passages ciblés trouvent bien plus d’erreurs qu’une relecture générale, et prennent moins de temps.' },
      { type: 'qcm', question: 'Quelle astuce rend la relecture plus efficace ?', choix: ['relire à voix basse en articulant', 'relire très vite', 'relire en commençant par la fin', 'faire relire par quelqu’un d’autre'], reponse: 0, explication: 'Les répétitions, les phrases trop longues et les accords manquants s’entendent bien mieux qu’ils ne se voient.' },
      { type: 'qcm', question: '« Le vélo est pratique. De plus, il est lent sur les longues distances. » Où est l’erreur ?', choix: ['le connecteur annonce un ajout alors que la phrase oppose', 'la phrase est trop longue', 'il manque un exemple', 'le temps est faux'], reponse: 0, explication: 'Il fallait en revanche ou cependant. Un connecteur placé au hasard ne crée aucun lien : il souligne seulement son absence. Mieux vaut trois connecteurs justes que dix plaqués.' },
      { type: 'qcm', question: 'Quelle est la structure d’un paragraphe argumentatif complet ?', choix: ['annoncer, expliquer, illustrer, conclure', 'thèse, antithèse, synthèse', 'titre, développement, exemple', 'question, réponse, exemple'], reponse: 0, explication: 'Annoncer l’argument, expliquer POURQUOI il soutient la thèse, illustrer par un exemple précis, puis conclure en revenant à la thèse. L’étape d’explication est celle qu’on oublie le plus souvent.' }
    ]
  }
,
  'physique-chimie/L07': {
    ...
    items: [
      { type: 'saisie', question: 'Quelle est l’unité de l’énergie ? (un mot)', reponses: ['le joule', 'joule', 'joules'], explication: 'Le joule, de symbole J. Toutes les formes d’énergie s’expriment dans la même unité : c’est ce qui permet de les comparer et de les additionner.' },
      { type: 'qcm', question: 'Quelle est la différence entre l’énergie et la puissance ?', choix: ['la puissance est un débit, l’énergie une quantité', 'ce sont deux mots pour la même chose', 'la puissance se mesure en joules', 'l’énergie se mesure en watts'], reponse: 0, explication: 'La puissance est l’énergie transférée CHAQUE SECONDE. Une ampoule de 10 W allumée dix heures consomme plus qu’une de 100 W allumée cinq minutes.' },
      { type: 'saisie', question: 'Quelle est la formule de l’énergie cinétique ? (sous la forme Ec = ...)', reponses: ['ec = 1/2 x m x v2', 'ec = 1/2 m v2', 'ec = 0,5 x m x v²', 'ec = 1/2 × m × v²', 'ec = 1/2 m v²'], explication: 'Ec = ½ × m × v², avec Ec en joules, m en KILOGRAMMES et v en MÈTRES PAR SECONDE.' },
      { type: 'qcm', question: 'Comment convertit-on des km/h en m/s ?', choix: ['on divise par 3,6', 'on multiplie par 3,6', 'on divise par 1 000', 'on multiplie par 60'], reponse: 0, explication: '90 km/h = 90 ÷ 3,6 = 25 m/s. Oublier cette conversion fausse le calcul d’énergie cinétique d’un facteur treize.' },
      { type: 'qcm', question: 'Si la vitesse d’un véhicule double, son énergie cinétique est multipliée par :', choix: ['quatre', 'deux', 'huit', 'elle ne change pas'], reponse: 0, explication: 'La vitesse intervient au CARRÉ : 2² = 4. La distance de freinage suit la même loi, ce qui est la raison physique des limitations de vitesse.' },
      { type: 'saisie', question: 'Une voiture de 1 000 kg roule à 20 m/s. Quelle est son énergie cinétique ? (en joules, chiffre seul)', reponses: ['200000', '200 000'], explication: 'Ec = 0,5 × 1 000 × 20² = 0,5 × 1 000 × 400 = 200 000 J, soit 200 kJ.' },
      { type: 'qcm', question: 'Quelle est la formule de l’énergie de position ?', choix: ['Ep = m × g × h', 'Ep = ½ × m × h', 'Ep = m × h', 'Ep = g × h'], reponse: 0, explication: 'Avec g ≈ 10 N/kg sur Terre et h en mètres. L’énergie de position se mesure toujours par rapport à une RÉFÉRENCE choisie, qu’il faut annoncer.' },
      { type: 'qcm', question: 'Une lampe reçoit de l’énergie électrique. Que fournit-elle ?', choix: ['de l’énergie lumineuse ET thermique', 'de l’énergie lumineuse seulement', 'de l’énergie chimique', 'de l’énergie cinétique'], reponse: 0, explication: 'Presque tous les convertisseurs produisent de la chaleur en plus de ce qu’on leur demande. Cette part n’est pas utile : c’est une perte, et aucun convertisseur réel n’y échappe.' },
      { type: 'qcm', question: 'Que reçoit et que fournit un alternateur ?', choix: ['reçoit cinétique, fournit électrique', 'refoit électrique, fournit cinétique', 'reçoit chimique, fournit électrique', 'reçoit lumineuse, fournit électrique'], reponse: 0, explication: 'C’est la pièce commune à presque toutes les centrales : seul change le moyen de le faire tourner, vapeur, eau ou vent.' },
      { type: 'vraifaux', question: 'Dans une chaîne énergétique, on représente aussi les pertes.', reponse: true, explication: 'Vrai : par des flèches partant sur le côté ou vers le bas, presque toujours nommées « thermique ». Une chaîne sans pertes ne décrit aucun dispositif réel.' },
      { type: 'qcm', question: 'Que dit le principe de conservation de l’énergie ?', choix: ['l’énergie ne se crée ni ne se détruit, elle se transforme', 'l’énergie disparaît peu à peu', 'l’énergie augmente à chaque conversion', 'l’énergie se conserve seulement dans le vide'], reponse: 0, explication: 'Une ampoule de 60 W émet 3 J de lumière et 57 J de chaleur : 3 + 57 = 60 J. Rien n’a disparu. Ce qui pose problème est la RÉPARTITION.' },
      { type: 'vraifaux', question: 'Dans une ampoule, une partie de l’énergie disparaît.', reponse: false, explication: 'Faux. Elle est CONVERTIE en chaleur, bien présente mais dispersée dans la pièce. Une « perte » n’est pas une disparition : c’est une conversion vers une forme inutilisable pour l’usage voulu.' },
      { type: 'saisie', question: 'Une ampoule reçoit 60 J et émet 3 J de lumière. Quel est son rendement ? (en pourcentage, chiffre seul)', reponses: ['5', '5 %', '5%'], explication: '3 ÷ 60 = 0,05, soit 5 %. Une ampoule à diodes atteint 30 à 50 % : c’est pourquoi elle éclaire autant en consommant six fois moins.' },
      { type: 'vraifaux', question: 'Un rendement peut dépasser 100 %.', reponse: false, explication: 'Faux, jamais. Cela signifierait qu’un appareil fournit plus d’énergie qu’il n’en reçoit, ce qui contredit le principe de conservation. Un tel résultat signale toujours une erreur.' },
      { type: 'qcm', question: 'Laquelle de ces sources n’est PAS renouvelable ?', choix: ['l’uranium', 'le solaire', 'l’éolien', 'la géothermie'], reponse: 0, explication: 'L’uranium est un stock limité, comme le charbon, le pétrole et le gaz. Renouvelable signifie que la ressource se reconstitue à l’échelle humaine.' },
      { type: 'vraifaux', question: 'Une source renouvelable est sans impact sur l’environnement.', reponse: false, explication: 'Faux. Un barrage noie des vallées, un panneau photovoltaïque demande des métaux et de l’énergie pour être fabriqué. « Renouvelable » décrit la reconstitution de la RESSOURCE, pas l’absence de conséquence.' },
      { type: 'qcm', question: 'D’où vient, en profondeur, l’énergie éolienne ?', choix: ['du Soleil', 'de la Terre', 'des noyaux d’atomes', 'de la Lune'], reponse: 0, explication: 'Le Soleil chauffe inégalement l’atmosphère, ce qui crée les vents. Presque toutes les sources viennent du Soleil : seules la géothermie et le nucléaire font exception.' },
      { type: 'qcm', question: 'Qu’est-ce qui fait tourner l’alternateur dans une centrale nucléaire ?', choix: ['de la vapeur d’eau', 'l’uranium directement', 'un moteur électrique', 'le vent'], reponse: 0, explication: 'Exactement comme dans une centrale à charbon : seule diffère la SOURCE DE CHALEUR. Le panneau photovoltaïque est la seule exception, sans aucune pièce en mouvement.' },
      { type: 'saisie', question: 'Combien de joules vaut 1 kWh ? (chiffre seul, sans espace)', reponses: ['3600000', '3 600 000'], explication: '1 kWh = 3 600 000 J. C’est pourquoi on emploie le kilowattheure en usage domestique : le nombre en joules est trop grand pour être manipulé commodément.' },
      { type: 'qcm', question: 'Un radiateur de 2 kW fonctionne 90 heures. Quelle énergie consomme-t-il ?', choix: ['180 kWh', '45 kWh', '2 000 kWh', '92 kWh'], reponse: 0, explication: 'E = P × t = 2 × 90 = 180 kWh. Attention : pour obtenir des kWh, la puissance doit être en KILOWATTS et la durée en HEURES.' }
    ]
  }
,
  "physique-chimie/L08": {
    titre: "La lumière",
    items: [
      { type: "qcm", question: "Parmi ces objets, lequel est une source primaire de lumière ?",
      ...
      { type: "vraifaux", question: "Dans une pièce parfaitement dépoussiérée, on voit le trajet d'un faisceau laser de côté.",
        reponse: false,
      ...
      { type: "qcm", question: "Quelles sont les deux conditions sur le milieu pour que la lumière se propage en ligne droite ?",
      ...
      { type: "qcm", question: "Le papier calque laisse passer la lumière mais ne permet pas de distinguer ce qu'il y a derrière. Il est :",
      ...
      { type: "saisie", question: "Comment s'appelle la zone sombre dessinée sur l'écran, derrière un objet opaque ? Deux mots.",
      ...
      { type: "vraifaux", question: "Avec une source ponctuelle, il n'y a pas de pénombre.",
        reponse: true,
      ...
      { type: "qcm", question: "Lors d'une éclipse de Soleil, quel astre se trouve entre les deux autres ?",
      ...
      { type: "saisie", question: "Quelle est la valeur de la vitesse de la lumière dans le vide, en km/s ? Écris le nombre sans espace.",
      ...
      { type: "qcm", question: "La Lune est à 384 000 km. Combien de temps sa lumière met-elle pour nous parvenir ?",
      ...
      { type: "qcm", question: "Le Soleil est à 150 millions de km. La durée du trajet de sa lumière est :",
      ...
      { type: "vraifaux", question: "Une année-lumière est une durée.",
        reponse: false,
      ...
      { type: "qcm", question: "L'étoile Sirius est à 8,6 années-lumière. Cela signifie que :",
      ...
      { type: "qcm", question: "Une sonde est sur Mars, à 78 millions de km. Un ingénieur envoie une commande et attend la confirmation. Combien de temps s'écoule au minimum ?",
      ...
      { type: "saisie", question: "Quel instrument en verre, de forme triangulaire, permet de décomposer la lumière blanche ? Un mot.",
      ...
      { type: "qcm", question: "Quelles sont les trois couleurs primaires de la lumière, celles qui donnent du blanc quand on les superpose ?",
      ...
      { type: "qcm", question: "De quelle couleur paraît un tee-shirt rouge éclairé uniquement en lumière bleue ?",
      ...
      { type: "vraifaux", question: "Un objet blanc éclairé en lumière verte paraît vert.",
        reponse: true,
      ...
      { type: "qcm", question: "Quels sont les deux rayons particuliers à tracer pour construire l'image d'un point par une lentille convergente ?",
      ...
      { type: "qcm", question: "Une lentille a une distance focale de 10 cm. On place un objet à 20 cm. L'image est :",
      ...
      { type: "qcm", question: "L'image formée sur la rétine est :",
...
,
  "svt/L06": {
    ...
    items: [
      { type: "qcm", question: "Le peuplement d'un milieu, c'est :",
      ...
      { type: "saisie", question: "Quel instrument mesure l'éclairement d'un milieu ? Un mot.",
      ...
      { type: "qcm", question: "Au pied d'un mur, on trouve des mousses côté nord et des orpins côté sud. Pourquoi ?",
      ...
      { type: "qcm", question: "Quelle est la strate la plus basse d'une forêt, au niveau du sol ?",
      ...
      { type: "qcm", question: "Pourquoi les jacinthes des bois fleurissent-elles en avril et pas en juillet ?",
      ...
      { type: "vraifaux", question: "En hiver, la plupart des espèces d'un jardin ont réellement disparu.",
        reponse: false,
      ...
      { type: "qcm", question: "Pourquoi les hirondelles migrent-elles en Afrique ?",
      ...
      { type: "qcm", question: "Chez quel animal la température du corps chute vraiment pendant le sommeil hivernal ?",
      ...
      { type: "saisie", question: "Comment appelle-t-on l'organe souterrain gonflé de réserves d'une tulipe ? Un mot.",
      ...
      { type: "qcm", question: "Chez une plante annuelle comme le coquelicot, qu'est-ce qui passe l'hiver ?",
      ...
      { type: "qcm", question: "Quelles sont les trois conditions nécessaires à la germination d'une graine ?",
      ...
      { type: "vraifaux", question: "Une graine sèche est morte.",
        reponse: false,
      ...
      { type: "qcm", question: "Une graine de pissenlit porte une aigrette de poils. Quel est son mode de dispersion ?",
      ...
      { type: "qcm", question: "Pourquoi beaucoup de fruits sont-ils charnus et sucrés ?",
      ...
      { type: "saisie", question: "Quelles sont les trois étapes nécessaires pour qu'une espèce colonise un nouveau milieu ? Donne le verbe de la première.",
      ...
      { type: "qcm", question: "Le fraisier produit des stolons. Ce mode de multiplication donne des descendants :",
      ...
      { type: "vraifaux", question: "La multiplication végétative crée plus de diversité que la reproduction sexuée.",
        reponse: false,
      ...
      { type: "qcm", question: "La renouée du Japon se multiplie par rhizomes : un fragment de 2 cm suffit. Pourquoi les travaux de terrassement aggravent-ils sa propagation ?",
      ...
      { type: "qcm", question: "Un agriculteur arrache une haie. Trois ans plus tard, les ravageurs augmentent. Pourquoi ?",
      ...
      { type: "qcm", question: "Quelle action augmente le nombre d'espèces présentes dans un jardin ?",
...
,
  "svt/L07": {
    ...
    items: [
      { type: "qcm", question: "Une ressource est dite renouvelable si :",
      ...
      { type: "vraifaux", question: "Une ressource renouvelable ne peut jamais s'épuiser.",
        reponse: false,
      ...
      { type: "qcm", question: "Quelle part de l'eau douce prélevée dans le monde est utilisée par l'agriculture ?",
      ...
      { type: "qcm", question: "Combien de temps faut-il environ pour former 1 cm de sol fertile ?",
      ...
      { type: "saisie", question: "Comment appelle-t-on la concentration progressive d'un polluant tout au long d'une chaîne alimentaire ? Un mot.",
      ...
      { type: "qcm", question: "Sans effet de serre naturel, quelle serait la température moyenne à la surface de la Terre ?",
      ...
      { type: "vraifaux", question: "L'effet de serre est une pollution provoquée par l'être humain.",
        reponse: false,
      ...
      { type: "qcm", question: "Dans l'effet de serre, que font les gaz comme le CO₂ ?",
      ...
      { type: "qcm", question: "La concentration de CO₂ est passée de 280 ppm à 420 ppm. Quelle est l'augmentation en pourcentage ?",
        choix: ["+ 33 %", "+ 50 %", "+ 140 %", "+ 66 %"],
        reponse: 1,
      ...
      { type: "qcm", question: "Quelle durée minimale faut-il pour parler de climat plutôt que de météo ?",
      ...
      { type: "qcm", question: "Pourquoi la fonte de la banquise arctique ne fait-elle presque pas monter le niveau des mers ?",
      ...
      { type: "qcm", question: "Quelle est la première cause du recul de la biodiversité ?",
      ...
      { type: "vraifaux", question: "La biodiversité se résume au nombre d'espèces présentes.",
        reponse: false,
      ...
      { type: "qcm", question: "Dans le vocabulaire des risques, comment appelle-t-on le phénomène dangereux lui-même ?",
      ...
      { type: "saisie", question: "Complète la relation : risque = aléa × enjeu × … ? Un mot.",
      ...
      { type: "qcm", question: "Une norme obligeant à construire des bâtiments parasismiques relève de :",
      ...
      { type: "qcm", question: "Une commune est passée de 12 % à 34 % de surface bétonnée et subit des crues plus fortes, sans que les pluies aient augmenté. Pourquoi ?",
      ...
      { type: "qcm", question: "Une gestion durable, c'est :",
      ...
      { type: "qcm", question: "Quelles sont les trois dimensions d'une gestion durable ?",
      ...
      { type: "qcm", question: "Pourquoi les quotas de pêche sont-ils souvent instaurés trop tard ?",
...
,
  "histoire-geo/H6": {
    ...
    items: [
      { type: "qcm", question: "Combien de régimes politiques différents la France connaît-elle entre 1815 et 1914 ?",
      ...
      { type: "saisie", question: "Comment appelle-t-on le montant minimum d'impôt qu'il fallait payer pour voter avant 1848 ? Un mot.",
      ...
      { type: "vraifaux", question: "La Restauration de 1815 rétablit les privilèges de la noblesse et l'Ancien Régime.",
        reponse: false,
      ...
      { type: "qcm", question: "Que se passe-t-il en juillet 1830 lors des Trois Glorieuses ?",
      ...
      { type: "qcm", question: "Que se passe-t-il le 2 mars 1848 ?",
      ...
      { type: "vraifaux", question: "En 1848, le suffrage universel concerne aussi les femmes.",
        reponse: false,
      ...
      { type: "qcm", question: "Qui prépare le décret d'abolition de l'esclavage du 27 avril 1848 ?",
      ...
      { type: "qcm", question: "Louis-Napoléon Bonaparte et Napoléon III sont :",
      ...
      { type: "qcm", question: "Quel événement militaire précède immédiatement la proclamation de la IIIᵉ République ?",
      ...
      { type: "vraifaux", question: "L'Assemblée élue en février 1871 était majoritairement républicaine.",
        reponse: false,
      ...
      { type: "qcm", question: "Que règle la crise du 16 mai 1877 ?",
      ...
      { type: "qcm", question: "En quelle année la liberté de la presse est-elle instaurée en France ?",
      ...
      { type: "saisie", question: "En quelle année les syndicats sont-ils autorisés en France, par la loi Waldeck-Rousseau ?",
        reponses: ["1884", "en 1884"],
      ...
      { type: "qcm", question: "Quels sont les trois principes de l'école de Jules Ferry ?",
      ...
      { type: "qcm", question: "Pourquoi l'école est-elle un enjeu politique pour la IIIᵉ République ?",
      ...
      { type: "qcm", question: "Que dit l'article 1 de la loi du 9 décembre 1905 ?",
      ...
      { type: "vraifaux", question: "La laïcité interdit de pratiquer une religion.",
        reponse: false,
      ...
      { type: "qcm", question: "Quel régime la loi de 1905 remplace-t-elle ?",
      ...
      { type: "qcm", question: "Quelle différence y a-t-il entre être gracié et être réhabilité ?",
      ...
      { type: "qcm", question: "En 1914, quel groupe n'a toujours pas le droit de vote en France ?",
...
,
  "histoire-geo/G5": {
    ...
    items: [
      { type: "qcm", question: "Quelle part du commerce mondial passe par la mer, en volume ?",
      ...
      { type: "saisie", question: "Comment appelle-t-on le processus par lequel les économies dépendent de plus en plus de la mer ? Un mot.",
      ...
      { type: "qcm", question: "Que signifie EVP ?",
      ...
      { type: "vraifaux", question: "Le conteneur est avant tout une invention technologique.",
        reponse: false,
      ...
      { type: "qcm", question: "Quel effet principal le conteneur a-t-il eu sur le commerce mondial ?",
      ...
      { type: "qcm", question: "Pourquoi les armateurs construisent-ils des navires toujours plus grands ?",
      ...
      { type: "qcm", question: "Quel passage relie la Méditerranée à la mer Rouge et voit passer environ 12 % du commerce mondial ?",
      ...
      { type: "qcm", question: "Par quel détroit transite environ 20 % du pétrole mondial ?",
      ...
      { type: "qcm", question: "Quel est le premier port mondial en trafic de conteneurs ?",
      ...
      { type: "saisie", question: "Comment appelle-t-on l'arrière-pays continental desservi par un port ? Un mot.",
      ...
      { type: "vraifaux", question: "La quasi-totalité des données internet intercontinentales passe par des satellites.",
        reponse: false,
      ...
      { type: "qcm", question: "Quelle est l'étendue maximale d'une zone économique exclusive ?",
      ...
      { type: "qcm", question: "Que donne exactement une ZEE à l'État côtier ?",
      ...
      { type: "qcm", question: "Quel traité international définit les zones maritimes et les droits des États ?",
      ...
      { type: "qcm", question: "La France possède la deuxième ZEE du monde. D'où vient l'essentiel de cette surface ?",
      ...
      { type: "qcm", question: "Pourquoi un îlot inhabité de quelques centaines de mètres carrés peut-il être disputé par plusieurs États ?",
      ...
      { type: "qcm", question: "Quelle part des stocks de poissons est aujourd'hui surexploitée ?",
      ...
      { type: "qcm", question: "Quelle part de l'excès de chaleur lié au réchauffement l'océan a-t-il absorbée ?",
      ...
      { type: "vraifaux", question: "Plus de la moitié de la surface marine est aujourd'hui protégée.",
        reponse: false,
      ...
      { type: "qcm", question: "Que montre le blocage du canal de Suez par l'Ever Given en mars 2021 ?",
...
,
  "histoire-geo/G6": {
    ...
    items: [
      { type: "qcm", question: "Quelle part du PIB mondial les États-Unis produisent-ils, pour environ 4 % de la population mondiale ?",
      ...
      { type: "qcm", question: "Le soft power, c'est la capacité d'influencer :",
      ...
      { type: "saisie", question: "Quelle monnaie représente environ 58 % des réserves de change des banques centrales du monde ? Un mot.",
      ...
      { type: "vraifaux", question: "Les États-Unis dominent tous les domaines sans aucune concurrence.",
        reponse: false,
      ...
      { type: "qcm", question: "Dans un téléphone vendu 1 000 €, l'assemblage représente environ 3 % du prix. Que montre ce chiffre ?",
      ...
      { type: "saisie", question: "Comment appelle-t-on un espace qui associe universités, laboratoires, entreprises innovantes et financeurs ? Un mot.",
      ...
      { type: "qcm", question: "La métropolisation, c'est la concentration dans les grandes villes :",
      ...
      { type: "qcm", question: "Que désigne le CBD d'une métropole américaine ?",
      ...
      { type: "vraifaux", question: "Aux États-Unis, les quartiers les plus riches sont généralement au centre-ville.",
        reponse: false,
      ...
      { type: "qcm", question: "Qu'est-ce qu'une edge city ?",
      ...
      { type: "qcm", question: "La Megalopolis s'étend de :",
      ...
      { type: "qcm", question: "Quelle façade maritime américaine est tournée vers l'Asie ?",
      ...
      { type: "saisie", question: "Comment appelle-t-on une zone de contact entre deux espaces différents, où se concentrent les échanges ? Un mot.",
      ...
      { type: "qcm", question: "Que désigne la Rust Belt ?",
      ...
      { type: "qcm", question: "Qu'est-ce qui a attiré population et activités vers la Sun Belt depuis les années 1950 ?",
      ...
      { type: "qcm", question: "Quelle est la longueur approximative de la frontière entre les États-Unis et le Mexique ?",
      ...
      { type: "saisie", question: "Comment appelle-t-on une usine d'assemblage installée du côté mexicain de la frontière ? Un mot.",
      ...
      { type: "qcm", question: "Pourquoi dit-on que la frontière mexicaine est sélective ?",
      ...
      { type: "qcm", question: "Pourquoi la frontière canadienne, bien plus longue, est-elle beaucoup moins contrôlée que la frontière mexicaine ?",
      ...
      { type: "qcm", question: "Qu'est-ce qu'un gated community ?",
...
,
  "emc/L04": {
    ...
    items: [
      { type: "qcm", question: "Quel article de la Déclaration des droits de l'homme et du citoyen de 1789 fonde la liberté d'expression ?",
      ...
      { type: "qcm", question: "Que change la loi du 29 juillet 1881 ?",
      ...
      { type: "vraifaux", question: "La liberté d'expression autorise à dire absolument tout.",
        reponse: false,
      ...
      { type: "qcm", question: "Affirmer sans preuve qu'un commerçant revend de la viande périmée, c'est :",
      ...
      { type: "qcm", question: "Quelle est la différence entre critiquer une religion et s'en prendre à ses fidèles ?",
      ...
      { type: "vraifaux", question: "Être choqué par un propos suffit à le rendre illégal.",
        reponse: false,
      ...
      { type: "qcm", question: "« Le Mont Blanc culmine à 4 806 m. » Cette phrase est :",
      ...
      { type: "saisie", question: "Quelle question faut-il se poser avant de partager une information ? Complète : est-ce que je sais d'où ça … ?",
      ...
      { type: "qcm", question: "Une photo d'inondation authentique circule en annonçant une catastrophe locale, alors qu'elle a été prise ailleurs sept ans plus tôt. Que montre cet exemple ?",
      ...
      { type: "qcm", question: "Parmi ces formules, laquelle est un signal d'alerte typique d'une fausse information ?",
      ...
      { type: "qcm", question: "Que cherche principalement un algorithme de recommandation ?",
      ...
      { type: "saisie", question: "Comment appelle-t-on la situation où l'on ne voit plus que des contenus confirmant ce qu'on pense déjà ? Complète : une bulle de … .",
      ...
      { type: "vraifaux", question: "Un compte anonyme sur un réseau social est impossible à identifier.",
        reponse: false,
      ...
      { type: "qcm", question: "Laquelle de ces informations n'est PAS une donnée personnelle ?",
      ...
      { type: "qcm", question: "Une application de retouche photo gratuite demande l'accès aux contacts, au micro et à la position. Que dit le RGPD ?",
      ...
      { type: "qcm", question: "Quel droit du RGPD te permet de demander la suppression de tes données ?",
      ...
      { type: "vraifaux", question: "Publier la photo d'une personne reconnaissable prise dans la rue ne nécessite aucune autorisation.",
        reponse: false,
      ...
      { type: "qcm", question: "Qu'est-ce qui caractérise juridiquement le cyberharcèlement ?",
      ...
      { type: "qcm", question: "« Je n'ai envoyé qu'un seul message, ce n'est pas grave. » Que répondre ?",
      ...
      { type: "qcm", question: "Tu es témoin de cyberharcèlement. Quelle est l'action la plus utile ?",
...
,
  "anglais-lv1/L07": {
    ...
    items: [
      { type: "qcm", question: "Quelle est la structure du conditional 1 ?",
      ...
      { type: "qcm", question: "Complète : If it ... tomorrow, we will stay at home.",
      ...
      { type: "qcm", question: "Complète : If I ... more money, I would travel the world.",
      ...
      { type: "vraifaux", question: "On peut écrire « If I would have time, I would help you ».",
        reponse: false,
      ...
      { type: "qcm", question: "Quelle phrase relève du conditional 0 ?",
      ...
      { type: "qcm", question: "Au conditional 2, quelle forme de « be » emploie-t-on à l'écrit, à toutes les personnes ?",
      ...
      { type: "qcm", question: "Où faut-il placer la virgule ?",
      ...
      { type: "saisie", question: "Corrige cette phrase : « If I was you, I would say no. » Écris le mot qui remplace « was ».",
      ...
      { type: "qcm", question: "Que signifie « unless » ?",
      ...
      { type: "vraifaux", question: "On peut écrire « unless you don't come ».",
        reponse: false,
      ...
      { type: "qcm", question: "Quelle est la différence entre « If it rains, I will take an umbrella » et « I will take an umbrella in case it rains » ?",
      ...
      { type: "qcm", question: "Complète : If you ... (finish) early, you can go out.",
      ...
      { type: "qcm", question: "« If I have time tonight, I will call you » et « If I had time tonight, I would call you » : quelle différence ?",
      ...
      { type: "qcm", question: "Traduis : « Si j'étais toi, je lui téléphonerais. »",
      ...
      { type: "qcm", question: "Transforme avec unless : « If you don't leave now, you will be late. »",
      ...
      { type: "vraifaux", question: "Dans « If I had a car, I would drive you », le prétérit « had » parle du passé.",
        reponse: false,
      ...
      { type: "qcm", question: "Quelle phrase est correcte ?",
      ...
      { type: "qcm", question: "Quel mot introduit une condition à respecter, au sens de « à condition que » ?",
      ...
      { type: "qcm", question: "Un ami dit : « If I could choose, I would live by the sea. » puis « If I save enough money, I will go in July. » Que signale ce changement de type ?",
      ...
      { type: "saisie", question: "Traduis en anglais : « Si tu arrives avant sept heures, nous irons au cinéma. » Écris le verbe qui suit « If you ».",
...
,
  "anglais-lv1/L08": {
    ...
    items: [
      { type: "qcm", question: "Que désigne « Great Britain » ?",
      ...
      { type: "vraifaux", question: "On peut dire « England » pour parler du Royaume-Uni.",
        reponse: false,
      ...
      { type: "qcm", question: "Quelle est la capitale de l'Écosse ?",
      ...
      { type: "qcm", question: "Quelle est la capitale de l'Australie ?",
      ...
      { type: "saisie", question: "Quelle est la capitale du Canada ? Un mot.",
      ...
      { type: "qcm", question: "Que représentent les 13 bandes du drapeau américain ?",
      ...
      { type: "qcm", question: "Que signifie « lingua franca » ?",
      ...
      { type: "qcm", question: "En anglais américain, comment dit-on « lift » ?",
      ...
      { type: "qcm", question: "Un Britannique commande des « chips ». Que reçoit-il ?",
      ...
      { type: "saisie", question: "Écris « colour » en anglais américain.",
      ...
      { type: "qcm", question: "Comment écrit-on « centre » en anglais américain ?",
      ...
      { type: "qcm", question: "Un Américain écrit « See you on 03/04 ». À quelle date te donne-t-il rendez-vous ?",
      ...
      { type: "qcm", question: "Un Britannique te donne rendez-vous « on the first floor ». Où vas-tu ?",
      ...
      { type: "qcm", question: "Que signifie « actually » ?",
      ...
      { type: "qcm", question: "Que signifie « library » ?",
      ...
      { type: "vraifaux", question: "Le te reo Māori est une langue officielle en Nouvelle-Zélande.",
        reponse: true,
      ...
      { type: "qcm", question: "Pour comprendre un document écrit, par quoi faut-il commencer ?",
      ...
      { type: "qcm", question: "Lors d'une compréhension orale, que fais-tu pendant la première écoute ?",
      ...
      { type: "qcm", question: "Quelle formule annonce la conclusion d'un exposé ?",
      ...
      { type: "qcm", question: "Comment prépare-t-on un bon exposé de trois minutes ?",
...
,
  "espagnol-lv2/L07": {
    ...
    items: [
      { type: "qcm", question: "Comment se forme le futur simple en espagnol ?",
      ...
      { type: "saisie", question: "Conjugue « comer » au futur simple, à la personne « nosotros ».",
        reponses: ["comeremos"],
      ...
      { type: "qcm", question: "Quelle forme est correctement écrite ?",
      ...
      { type: "qcm", question: "Quel est le radical du futur de « tener » ?",
      ...
      { type: "saisie", question: "Conjugue « hacer » au futur simple, à la personne « yo ».",
        reponses: ["hare", "haré"],
      ...
      { type: "qcm", question: "Complète : « Mañana no ... venir. » (poder, yo)",
      ...
      { type: "vraifaux", question: "On peut écrire « Habrán muchas personas ».",
        reponse: false,
      ...
      { type: "qcm", question: "« El tren sale a las ocho. » Quelle forme du futur est employée ?",
      ...
      { type: "qcm", question: "Que signifie « ¿Qué hora es? — Serán las tres. » ?",
      ...
      { type: "qcm", question: "« No contesta. Estará ocupado. » Comment traduire la deuxième phrase ?",
      ...
      { type: "qcm", question: "Complète : « Si ... mañana, no saldremos. » (llover)",
      ...
      { type: "qcm", question: "Complète : « Cuando ..., te llamo. » (llegar, tú)",
      ...
      { type: "vraifaux", question: "Après « si » et après « cuando », on emploie le même mode.",
        reponse: false,
      ...
      { type: "qcm", question: "« Cuando llego a casa, ceno. » Que décrit cette phrase ?",
      ...
      { type: "qcm", question: "Traduis « Je te le dirai quand je le saurai ».",
      ...
      { type: "qcm", question: "Comment dit-on « dans deux jours » ?",
      ...
      { type: "qcm", question: "« La semana que viene » et « la próxima semana » :",
      ...
      { type: "qcm", question: "« Mañana voy al cine », « Mañana voy a ir al cine », « Mañana iré al cine » : laquelle est fausse ?",
      ...
      { type: "qcm", question: "Quelle formule signifie « j'ai l'intention de » ?",
...
,
  "espagnol-lv2/L08": {
    ...
    items: [
      { type: "qcm", question: "Dans combien de pays souverains l'espagnol est-il langue officielle ?",
        choix: ["10", "15", "20", "30"],
        reponse: 2,
      ...
      { type: "vraifaux", question: "La majorité des hispanophones vivent en Espagne.",
        reponse: false,
      ...
      { type: "qcm", question: "Quel est le premier pays hispanophone du monde par la population ?",
      ...
      { type: "vraifaux", question: "Le Brésil est un pays hispanophone.",
        reponse: false,
      ...
      { type: "saisie", question: "Combien l'Espagne compte-t-elle de communautés autonomes ? Écris le nombre.",
      ...
      { type: "qcm", question: "Quelle langue parlée en Espagne n'est apparentée à aucune autre langue connue ?",
      ...
      { type: "qcm", question: "Que fait-on en Espagne aux douze coups de minuit le 31 décembre ?",
      ...
      { type: "qcm", question: "En Espagne, quel jour les enfants reçoivent-ils traditionnellement leurs cadeaux ?",
      ...
      { type: "qcm", question: "Où se déroulent Las Fallas, avec leurs sculptures géantes brûlées la nuit du 19 mars ?",
      ...
      { type: "qcm", question: "Qu'est-ce que l'encierro de San Fermín, à Pamplona ?",
      ...
      { type: "saisie", question: "Quelle est la fête nationale de l'Espagne, le 12 octobre ? Complète : Día de la … .",
      ...
      { type: "qcm", question: "Quand se célèbre le Día de Muertos au Mexique ?",
      ...
      { type: "vraifaux", question: "Le Día de Muertos est la version mexicaine d'Halloween.",
        reponse: false,
      ...
      { type: "qcm", question: "Quelle fleur orange guide les âmes vers l'ofrenda ?",
      ...
      { type: "qcm", question: "Quel est le symbole du Día de Muertos, squelette élégant en robe et chapeau ?",
      ...
      { type: "qcm", question: "Quelle est la fête nationale du Mexique ?",
      ...
      { type: "qcm", question: "Comment dit-on « vous » au pluriel, entre amis, en Amérique hispanophone ?",
      ...
      { type: "qcm", question: "Qu'est-ce que le voseo ?",
      ...
      { type: "qcm", question: "Comment dit-on « ordinateur » en Amérique hispanophone ?",
      ...
      { type: "qcm", question: "Pourquoi faut-il éviter le verbe « coger » dans une grande partie de l'Amérique ?",
