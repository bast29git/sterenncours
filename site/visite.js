...
(function () {
  ...
  const ETAPES = [
    ...
    { cible: '.e-nav a[href="#/jeux"]', titre: 'Jeux', texte: 'Vingt mondes en 3D et cinquante jeux, tous rattachés à une leçon. Une partie gagnée avec au moins deux étoiles compte comme une série réussie.' },
