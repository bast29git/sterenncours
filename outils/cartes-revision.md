...
duree: 15 min
objectifs:
  - Fabriquer des cartes de révision qui servent vraiment
  - Utiliser la répétition espacée plutôt que la relecture
---
...
C'est de **la retrouver** sans aide, plusieurs fois, à des moments espacés.
:::

## 2. Les règles d'une bonne carte

::: etapes
1. **Une seule question par carte.** Si la réponse tient en trois idées, il faut trois cartes.
2. **La question est fermée.** « Quelle est la formule de Pythagore ? » et non « Parle-moi de Pythagore ».
3. **La réponse tient en 2 lignes.** Au-delà, la carte est en réalité un résumé : il faut la découper.
4. **La carte se suffit à elle-même.** Pas de « voir la fiche » : la réponse est écrite en entier au dos.
:::

::: piege La carte piège
« Qu'est-ce que Pythagore ? » ne marche pas : on ne sait pas ce qui est attendu,
donc on ne peut pas savoir si on a réussi. Une carte doit permettre de **s'auto-corriger
sans hésitation**.
:::
...
::: info Durée d'une séance de cartes
**5 à 10 minutes**, pas plus. C'est la **fréquence** qui compte, pas la durée.
Tous les jours 7 minutes vaut bien mieux qu'une fois par semaine 50 minutes.
:::
...
| Quand écrit-on = et quand écrit-on ≈ ? | **=** pour une valeur exacte (BC = √74). **≈** dès qu'il y a un arrondi (BC ≈ 8,6 cm). |
| Quels sont les trois temps d'une démonstration ? | 1. Poser le cadre (où est l'angle droit). 2. Citer le théorème. 3. Calculer et conclure avec l'unité. |
| Quelle phrase doit précéder le calcul dans une démonstration ? | « **D'après le théorème de Pythagore** … » |
| Comment vérifier qu'un résultat de Pythagore est plausible ? | L'hypoténuse doit être **plus longue** que chacun des deux autres côtés. |
:::
...
- La question est fermée : je sais ce qui est attendu
- La réponse tient en deux lignes
- La carte se suffit à elle-même, sans renvoi à une fiche
:::
