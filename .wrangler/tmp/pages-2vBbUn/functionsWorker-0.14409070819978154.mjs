...
var maintenant = /* @__PURE__ */ __name(() => (/* @__PURE__ */ new Date()).toISOString(), "maintenant");
...
__name(json, "json");
var erreur = /* @__PURE__ */ __name((message, statut = 400) => json({ erreur: message }, statut), "erreur");
...
var hex = /* @__PURE__ */ __name((octets) => [...new Uint8Array(octets)].map((o) => o.toString(16).padStart(2, "0")).join(""), "hex");
...
var onRequestGet2 = gerer(async (context) => {
  ...
  const enObjet = /* @__PURE__ */ __name((lignes, cleChamp) => {
    const sortie = {};
...
var estPublic = /* @__PURE__ */ __name((chemin) => PUBLIC_EXACT.has(chemin) || PUBLIC_PREFIXES.some((p) => chemin.startsWith(p)), "estPublic");
...
// ../../../../tmp/claude-0/-home-user/426120ca-062e-56a4-8239-44cbe24a24ce/scratchpad/outils-test/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../tmp/claude-0/-home-user/426120ca-062e-56a4-8239-44cbe24a24ce/scratchpad/outils-test/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
//# sourceMappingURL=functionsWorker-0.14409070819978154.mjs.map
